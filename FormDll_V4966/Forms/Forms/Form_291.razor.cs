...
{
    public class Form_291Base : Form_291Peropeties
    {
    ...
    public override async Task<bool> FormValidator()
    {
        ...
        var List = _Entity.SCM_ProductRequestDetails.Where(p=>p.IsDelete == false).ToList();
            ...
            // دکمه ثبت و ادامه           
            if (BtnWorkFlowId == "SequenceFlow_04qthte"||BtnWorkFlowId == "SequenceFlow_1veewb5" )
            {
             ...
             // لغو کلی درخواست
            if (BtnWorkFlowId == "SequenceFlow_0cu95ra"||BtnWorkFlowId == "" )
            {
