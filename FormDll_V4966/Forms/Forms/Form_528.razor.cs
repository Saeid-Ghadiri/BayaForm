...
{
    public class Form_528Base : Form_528Peropeties
    {
    ...
    {
        // استعلام شماره 1
        Ref_SCMPETCO_OS_Details_SCMPETCO_OS_Details_InquiryFile1.SetVisible(Visible);
        // استعلام شماره 2
        Ref_SCMPETCO_OS_Details_SCMPETCO_OS_Details_InquiryFile2.SetVisible(Visible);
        // استعلام شماره 3
        Ref_SCMPETCO_OS_Details_SCMPETCO_OS_Details_InquiryFile3.SetVisible(Visible);
    }
	...
	public async Task  UploadFileIsEnable_oninput(ChangeEventArgs Selected ,Entity.SCMPETCO_OS_Details Item)
    {
        ...
        {
            // فیلد: منتج از پیمانکار با Code 13
            // if( _Entity.SCMPETCO_OS_ResultingFromId.ToString() == "2a087a09-9fbe-ef11-a4fa-005056a2b6bd")
            // {
            //     await ResultingFrom_Code13(true, true, _Entity);
            // }
            // else
            // {
            //     await ResultingFrom_Code13(false, false, _Entity);
            // }
        }
	...
	public async Task  InquiryIsEnable_oninput(ChangeEventArgs Selected ,Entity.SCMPETCO_OS_Details Item  )
    {
        // استعلام شماره 1
        var InquiryFileIsVisible = Ref_SCMPETCO_OS_Details_SCMPETCO_OS_Details_InquiryFile1;
        // استعلام شماره 2
        var InquiryFile2IsVisible = Ref_SCMPETCO_OS_Details_SCMPETCO_OS_Details_InquiryFile2;
        // استعلام شماره 3
        var InquiryFile3IsVisible = Ref_SCMPETCO_OS_Details_SCMPETCO_OS_Details_InquiryFile3;
