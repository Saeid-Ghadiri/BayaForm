...
{
    public class Form_292Base : Form_292Peropeties
    {
    ...
    public override async Task<bool> FormValidator()
    {
       bool IsValid = true;
        ...
        var List = _Entity.SCM_ProductRequestDetails.Where(p=>p.IsDelete == false).ToList();
            ...
            // دکمه ثبت و ادامه           
            if (BtnWorkFlowId == "SequenceFlow_0pkcu0e"||BtnWorkFlowId == "SequenceFlow_0e4x3s1" )
            {
             ...
             // لغو کلی درخواست
            if (BtnWorkFlowId == "SequenceFlow_0n379nx"||BtnWorkFlowId == "SequenceFlow_1kb7lx4" )
            {
