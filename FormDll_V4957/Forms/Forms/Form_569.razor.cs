...
{
    public class Form_569Base : Form_569Peropeties
    {
    ...
    // عطف تحویل کالا - حواله مصرف شماران سیستم
        ...
        {
            Ref_SCMPLATE_ProductRequestDetails_T_Search_NotMapped = null;
            Ref_SCMPLATE_ProductRequestDetails_T_CENTCODE = null;
            Ref_SCMPLATE_ProductRequestDetails_T_CENTCODE_GUID = null;
            Ref_SCMPLATE_ProductRequestDetails_T_PAYCENTName = null;
            Ref_SCMPLATE_ProductRequestDetails_T_CREATOR = null;
            Ref_SCMPLATE_ProductRequestDetails_T_FACTDATE = null;
            Ref_SCMPLATE_ProductRequestDetails_T_FACTNO = null;
            Ref_SCMPLATE_ProductRequestDetails_T_FACTNO_GUID = null;
            Ref_SCMPLATE_ProductRequestDetails_T_TEMPNO = null;
            Ref_SCMPLATE_ProductRequestDetails_T_TempNoNum = null;
            Ref_SCMPLATE_ProductRequestDetails_T_YEAR = null;
            Ref_SCMPLATE_ProductRequestDetails_SH_Tahvil_DTL = null;
        }
		...
		public async Task  Global_ShomaranInfoId_onitemselected(Entity.Global_ShomaranInfo Selected ,Entity.SCMPLATE_ProductRequestDetails Item  )
        {
            // انتخاب نوع ثبت عطف در شماران      
