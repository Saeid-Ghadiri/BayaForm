...
{
    public class Form_438Base : Form_438Peropeties
    {
        ...
        public override async Task<bool> FormValidator()
        {
            ...
            // دکمه ثبت و ادامه           
            if (BtnWorkFlowId == "SequenceFlow_04346h6"||BtnWorkFlowId == "SequenceFlow_07337k9")
            {
            ...
            // لغو کلی درخواست
            if (BtnWorkFlowId == "SequenceFlow_04uyvp5" || BtnWorkFlowId == "SequenceFlow_1fha4lm")
            {
