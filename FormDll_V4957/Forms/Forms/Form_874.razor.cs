...
{
    public class Form_874Base : Form_874Peropeties
    {
        // Toast  
        [Inject]
        ...
        public override async Task<bool> FormValidator()
        {
            ...
            // دکمه ثبت و ادامه           
            if ((BtnWorkFlowId == "SequenceFlow_1pjsl6z") || (BtnWorkFlowId == "SequenceFlow_1levyrp") || (BtnWorkFlowId == "SequenceFlow_1eqgthp")|| (BtnWorkFlowId == "SequenceFlow_0p2v1jh"))
            {
