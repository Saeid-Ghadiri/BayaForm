...
{
    public class Form_544Base : Form_544Peropeties
    {
...
return new Result() { Status = HttpStatusCode.OK };
	...
	public async Task<bool> SCM_OS_Details_editmodelsaving(object e   )
    {
        ...
        // فیلد اولویت
        if (ModelDetail.SCM_PriorityId == null || ModelDetail.SCM_PriorityId  == Guid.Empty)
        ...
        // SCM_UnitsId
        if (ModelDetail.SCM_UnitsId == null || ModelDetail.SCM_UnitsId  == Guid.Empty)
