...
{
    public class Form_541Base : Form_541Peropeties
    {
    ...
    public override async Task<bool> FormValidator()
    {
        ...
        foreach(var Item in List)
         {
             // InqueryApproveNum - شماره استعلام مورد تایید (تاییدکننده واحد)
...
return new Result() { Status = HttpStatusCode.OK };
    ...
    public async Task <bool> SCM_OS_Details_editmodelsaving(object e   )
        {
            ...
            // InqueryApproveNum
            if (MainModel.InqueryApproveNum == null)
	        {
	        	IsValid = true;            
	        	toastService.ShowError("لطفا گزینه شماره استعلام مورد تایید (تاییدکننده واحد) را تکمیل نمایید.",
	        	settings => {
    ...
    public async Task  SCM_OS_Details_afterrendermodal(Entity.SCM_OS_Details Item   )
		...
		// public async Task  SCM_OS_Details_UploadFile_oncut(ClipboardEventArgs Selected ,Entity.SCM_OS_Details Item  )
        // {
