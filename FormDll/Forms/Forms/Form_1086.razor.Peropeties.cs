...
{
    public class Form_1086Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SH_ATLASCELL_ReturnHavale> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SH_ATLASCELL_ReturnHavale())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1086_CU RefForm { get; set; }
    public Form_1086_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SH_ATLASCELL_ReturnHavale;
