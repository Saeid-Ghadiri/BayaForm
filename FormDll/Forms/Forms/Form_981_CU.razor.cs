...
namespace Forms.Forms
{
    public class Form_981_CUBase : Form_981_CUPeropeties
    {
        ...
        public async Task ProductSearch_onitemselected(dynamic Selected, Entity.Shomaran_FactbBuyDetail Item)
        {
            /// <summary>
        ...
        public async Task GridShomaran_FactbBuyId_729_afterrendermodal(Entity.Shomaran_FactbBuyDetail Item)
        {
            if (Item.Year == null)
            {
                var pc = new PersianCalendar();
                ...
                Ref_Shomaran_FactbBuyDetail_Year.Value = persianYear;
            }


            if (_Entity.FACTNO == null)
            {
                Ref_Shomaran_FactbBuyDetail_RowId.Value = _Entity.Shomaran_FactbBuyDetail.Count() + 1;
            }
