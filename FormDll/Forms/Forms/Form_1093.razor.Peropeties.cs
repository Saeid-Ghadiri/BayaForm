...
{
    public class Form_1093Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMATLASCELL_NQGT_WarehouseByLogistics> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMATLASCELL_NQGT_WarehouseByLogistics())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1093_CU RefForm { get; set; }
    public Form_1093_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMATLASCELL_NQGT_WarehouseByLogistics;
