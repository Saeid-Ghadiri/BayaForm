...
{
    public class Form_1084_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_ATLASCELL_Trans? _Entity { get; set; } = new Entity.SH_ATLASCELL_Trans();
...
public DxGrid? Grid_SH_ATLASCELL_TransDetail;

public Dropdown Ref_SH_ATLASCELL_TransDetail_ProductSearch;
public Input<string?> Ref_SH_ATLASCELL_TransDetail_PartCode;
public Input<string?> Ref_SH_ATLASCELL_TransDetail_ProductName;
public Input<string?> Ref_SH_ATLASCELL_TransDetail_ShomareFani;
public Input<string?> Ref_SH_ATLASCELL_TransDetail_Unit;
public Input<decimal?> Ref_SH_ATLASCELL_TransDetail_Amount;
public Input<string?> Ref_SH_ATLASCELL_TransDetail_Note;
public Input<string?> Ref_SH_ATLASCELL_TransDetail_Radyabi;
public Input<string?> Ref_SH_ATLASCELL_TransDetail_Sefaresh;
public Input<string?> Ref_SH_ATLASCELL_TransDetail_RowOrder;
public Input<int?> Ref_SH_ATLASCELL_TransDetail_Year;
public Dropdown Ref_SH_ATLASCELL_TransDetail_SH_ATLASCELL_TransId;
