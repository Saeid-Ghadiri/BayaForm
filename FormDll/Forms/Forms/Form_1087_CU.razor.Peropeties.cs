...
{
    public class Form_1087_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_ATLASCELL_SefareshPoint? _Entity { get; set; } = new Entity.SH_ATLASCELL_SefareshPoint();
...
public Input<string?> Ref_Unit;
public Input<string?> Ref_Unit1;
public Input<string?> Ref_Sefaresh;
public Input<string?> Ref_Radyabi;
public Input<string?> Ref_TecNO;
public Input<int?> Ref_Year;
public Input<string?> Ref_ApiResult;
public Dropdown Ref_SefareshPoint_List;
