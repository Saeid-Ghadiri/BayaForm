...
namespace Forms.Forms
{
    public class Form_500Base : Form_500Peropeties
    {
        ...
        public async Task KharidIsNull(Entity.SCMPETCO_ProductRequestDetails Item)
        {
            ...
            //Item.KH_Search_NotMapped = null;
            Item.KH_APPROVER = null;
            Item.KH_CENTCODE = null;
            Item.KH_CENTCODE = null;
            Item.KH_CENTCODE_GUID = null;
            Item.KH_PAYCENTName = null;
            Item.KH_WUSER = null;
            Item.KH_TEMPNO = null;
            Item.KH_TempNoNum = null;
            Item.KH_ORDERNO = null;
            Item.KH_ORDERNO_GUID = null;
            Item.KH_ORDERDATE = null;
            Item.KH_OKFACTDATE = null;
            Item.KH_INVCODE = null;
            Item.KH_REQPERSON = null;
            Item.KH_YEAR = null;
            Item.SH_Kharid_DTL = null;
        }
        ...
        public async Task ResidAnbarIsNull(Entity.SCMPETCO_ProductRequestDetails Item)
        {
            ...
            // Item.FB_Search_NotMapped = null;  // فیلد نات مپ ه
        ...
        public async Task SCMPETCO_ProductRequestDetails_afterrendermodal(Entity.SCMPETCO_ProductRequestDetails Item)
        {
            ...
            else
            {
                ...
                if (Item.Global_ShomaranInfoId.ToString() == "a5b1bc7b-8bb7-ef11-a4fa-005056a2b6bd")
                {
                    ...
                    await KharidIsVisible(false);
                    await KharidIsNull(Item);

                    await ResidAnbarIsVisible(false);
                    await ResidAnbarIsNull(Item);
                }
