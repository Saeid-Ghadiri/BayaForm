...
{
    public class Form_1066Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.ITIL_Request> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.ITIL_Request())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1066_CU RefForm { get; set; }
    public Form_1066_Filter RefListFilter  { get; set; }

public DxGrid? Grid_ITIL_Request;
