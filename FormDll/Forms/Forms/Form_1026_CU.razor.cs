...
{
    public class Form_1026_CUBase : Form_1026_CUPeropeties
    {
    ...
    public override async Task AfterGetData()
    {
        ...
        public async Task<bool> AddAnnar()
        {
            ...
            if (_Entity._IdIsEmpty.Value)
            {
                ...
                var data = await ApiServer.External.Services.ShomaranPetco.CreateAnnar(ShomaranApiMode.Petco, annarData);
            ...
            else
            {
                ...
                //var data = await ApiServer.External.Services.ShomaranPetco.UpdateAnnar(ShomaranApiMode.Petco, depoInData);
...
namespace ApiServer.External.Services
{
    public partial class ShomaranPetco
    {
        ...
        public static async Task<Result> CreateAnnar(ShomaranApiMode ApiMode, AnnarrHeader depoIn)
        {
            ...
            Result apiresult = await Send.PostAsync(_content, "ShomaranPetco/InsertAnnarr", shomaranApi, ApplicationType.None);
        ...
        public static async Task<Result> UpdateAnnar(ShomaranApiMode ApiMode, AnnarrUpdateInput depoIn)
        {
            ...
            // to match the correct one for creating a "Havale".
            Result apiresult = await Send.PostAsync(_content, "ShomaranPetco/UpdateAnnarr", shomaranApi, ApplicationType.None);
        ...
        public static async Task<Result> DeleteAnnar(ShomaranApiMode ApiMode, string annarrno, int year)
        {
            ...
            var _content = new StringContent(DataJson, Encoding.UTF8, "application/json");
            Result apiresult = await Send.PostAsync(_content, $"ShomaranPetco/DeleteAnnar/{annarrno}/{year}", shomaranApi, ApplicationType.None);
            return apiresult;
        }
