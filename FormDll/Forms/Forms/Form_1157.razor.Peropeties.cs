...
{
    public class Form_1157Peropeties : FormBase
    {
...
public RadioBoolean Ref_SCMPLATE_OS_Details_IsEnableApproved;
public Input<string?> Ref_SCMPLATE_OS_Details_DTFA_DeliveryProcurement;
