...
{
    public class Form_1085_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_ATLASCELL_FactbBuy? _Entity { get; set; } = new Entity.SH_ATLASCELL_FactbBuy();
...
public DxGrid? Grid_SH_ATLASCELL_FactbBuyDetail;

public Dropdown Ref_SH_ATLASCELL_FactbBuyDetail_ProductSearch;
public Input<string?> Ref_SH_ATLASCELL_FactbBuyDetail_ShomareFani;
public Input<string?> Ref_SH_ATLASCELL_FactbBuyDetail_ProductName;
public Input<string?> Ref_SH_ATLASCELL_FactbBuyDetail_Unit;
public Input<string?> Ref_SH_ATLASCELL_FactbBuyDetail_PartCode;
public Input<decimal?> Ref_SH_ATLASCELL_FactbBuyDetail_Amount;
public Input<string?> Ref_SH_ATLASCELL_FactbBuyDetail_Radyabi;
public Input<string?> Ref_SH_ATLASCELL_FactbBuyDetail_Sefaresh;
public Input<int?> Ref_SH_ATLASCELL_FactbBuyDetail_RowId;
public Input<int?> Ref_SH_ATLASCELL_FactbBuyDetail_Year;
public Dropdown Ref_SH_ATLASCELL_FactbBuyDetail_SH_ATLASCELL_FactbBuyId;
