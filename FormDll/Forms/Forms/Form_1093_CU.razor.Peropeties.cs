...
{
    public class Form_1093_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMATLASCELL_NQGT_WarehouseByLogistics? _Entity { get; set; } = new Entity.SCMATLASCELL_NQGT_WarehouseByLogistics();
