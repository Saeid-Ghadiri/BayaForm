...
{
    public class Form_1121_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMNFP_CostCenter? _Entity { get; set; } = new Entity.SCMNFP_CostCenter();
...
public Input<int?> Ref_CostCenterCode;
public Input<string?> Ref_CostCenterTitle;
