...
{
    public class Form_1063Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.ITIL_Operation> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.ITIL_Operation())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1063_CU RefForm { get; set; }
    public Form_1063_Filter RefListFilter  { get; set; }

public DxGrid? Grid_ITIL_Operation;
