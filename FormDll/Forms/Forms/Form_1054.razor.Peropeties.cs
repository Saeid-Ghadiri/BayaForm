...
{
    public class Form_1054Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMNFP_SCMNFP_Anbar> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMNFP_SCMNFP_Anbar())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1054_CU RefForm { get; set; }
    public Form_1054_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMNFP_SCMNFP_Anbar;
