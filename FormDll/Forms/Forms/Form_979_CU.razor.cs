...
namespace Forms.Forms
{
    public class Form_979_CUBase : Form_979_CUPeropeties
    {
        ...
        public async Task ProductSearch_onitemselected(dynamic Selected, Entity.Shomaran_AnnarrDetail Item)
        {
            /// <summary>
        ...
        public async Task GridShomaran_AnnarId_725_afterrendermodal(Entity.Shomaran_AnnarrDetail Item)
        {
            if(Item.YEAR == null)
            {
                var pc = new PersianCalendar();
                ...
                Ref_Shomaran_AnnarrDetail_YEAR.Value = persianYear;
            }
            

            if (_Entity.AnnarrNo == null)
            {
                Ref_Shomaran_AnnarrDetail_RowId.Value = (_Entity.Shomaran_AnnarrDetail.Count() + 1).ToString();
            }
