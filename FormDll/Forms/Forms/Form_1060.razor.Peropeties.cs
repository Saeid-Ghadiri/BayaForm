...
{
    public class Form_1060Peropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_Salary? _Entity { get; set; } = new Entity.HR_Salary();
...
public Input<string?> Ref_HagheOlad;
...
public Input<string?> Ref_HaghePost;
public Input<string?> Ref_MandegariPost;
...
public Input<string?> Ref_Mamooriat;
...
public Input<string?> Ref_Mosaede;
...
public Input<string?> Ref_VaamZaroori;
