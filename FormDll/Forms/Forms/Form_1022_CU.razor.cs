...
{
    public class Form_1022_CUBase : Form_1022_CUPeropeties
    {
        ...
        public async Task<bool> AddAnbord()
        {
            ...
            Console.WriteLine("#_Entity.PSOURCE:" + _Entity.PSOURCE);
            ...
            {
                //// ثبت
                var anbordDetails = _Entity.SH_Petco_AnbordDetail.Select(p => new AnbordDetailDto()
                {
                ...
                AnbordDto anbordData = new()
                {
                    ...
                    Psource = Convert.ToInt32(_Entity.PSOURCE),
                ...
                var data = await ApiServer.External.Services.ShomaranPart.CreateAnbord2(ShomaranApiMode.Petco, anbordData);
            ...
            else
            {
                ...
                //var data = await ApiServer.External.Services.ShomaranPart.UpdateAnbord2(ShomaranApiMode.Petco, anbordDto);
        ...
        public async Task<bool> GridSH_Petco_AnbordId_763_editmodelsaving(object e)
        {
            var Item = (Entity.SH_Petco_AnbordDetail)e;
        ...
        public async Task GridSH_Petco_AnbordId_763_afterrendermodal(Entity.SH_Petco_AnbordDetail Item)
        {
            ...
            if (Item.Year == null)
            {
                ...
                Ref_SH_Petco_AnbordDetail_Year.Value = persianYear;
            }

            if (_Entity.ORDERNO == null)
            {
                Ref_SH_Petco_AnbordDetail_RowId.Value = (_Entity.SH_Petco_AnbordDetail.Count() + 1).ToString();
            }
        }

        public async Task ProductSearch_onitemselected(dynamic Selected, Entity.SH_Petco_AnbordDetail Item)
        {
            /// <summary>
...
namespace ApiServer.External.Services
{
    public partial class ShomaranPetco
    {
        ...
        public static async Task<Result> CreateAnbord(ShomaranApiMode ApiMode, AnbordDto anbordDto)
        {
            ...
            Result apiresult = await Send.PostAsync(_content, "ShomaranPetco/InsertAnbord", shomaranApi, ApplicationType.None);
        ...
        public static async Task<Result> UpdateAnbord(ShomaranApiMode ApiMode, UpdateAnbordInput anbordDto)
        {
            ...
            // Note: You may need to change the API endpoint "ShomaranHavale/InsertHavale"
            // to match the correct one for creating a "Havale".
            Result apiresult = await Send.PostAsync(_content, "ShomaranPetco/UpdateAnbord", shomaranApi, ApplicationType.None);
