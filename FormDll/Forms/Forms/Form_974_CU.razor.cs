...
namespace Forms.Forms
{
    public class Form_974_CUBase : Form_974_CUPeropeties
    {
        ...
        public async Task ProductSearch_onitemselected(dynamic Selected, Entity.Shomaran_DepoInDetail Item)
        {
        ...
        public async Task GridShomaran_DepoInId_717_afterrendermodal(Entity.Shomaran_DepoInDetail Item)
        {
            if(Item.Year== null)
            {
                var pc = new PersianCalendar();
                ...
                Ref_Shomaran_DepoInDetail_Year.Value = persianYear;
            }
            

            if (_Entity.RecNo == null)
            {
                Ref_Shomaran_DepoInDetail_RowId.Value = (_Entity.Shomaran_DepoInDetail.Count() + 1).ToString();
            }
        }
