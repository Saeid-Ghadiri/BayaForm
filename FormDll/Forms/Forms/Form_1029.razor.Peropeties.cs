...
{
    public class Form_1029Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SH_Petco_ReturnHavale> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SH_Petco_ReturnHavale())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1029_CU RefForm { get; set; }
    public Form_1029_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SH_Petco_ReturnHavale;
