    ...
    public class Form_1027_CUBase : Form_1027_CUPeropeties
    {
        ...
        public async Task<bool> AddTrans()
        {
            ...
            if (_Entity._IdIsEmpty.Value)
            {
                ...
                var data = await ApiServer.External.Services.ShomaranPetco.CreateTrans(ShomaranApiMode.Petco, transData);
            ...
            else
            {
                ...
                //var data = await ApiServer.External.Services.ShomaranPetco.UpdateTrans(ShomaranApiMode.Petco, transData);
...
namespace ApiServer.External.Services
{
    public partial class ShomaranPetco
    {
        ...
        public static async Task<Result> CreateTrans(ShomaranApiMode ApiMode, TransInput trans)
        {
            ...
            Result apiresult = await Send.PostAsync(_content, "ShomaranPetco/InsertTrans", shomaranApi, ApplicationType.None);
        ...
        public static async Task<Result> UpdateTrans(ShomaranApiMode ApiMode, TransUpdateInput trans)
        {
            ...
            // to match the correct one for creating a "Havale".
            Result apiresult = await Send.PostAsync(_content, "ShomaranPetco/UpadteTrans", shomaranApi, ApplicationType.None);
        ...
        public static async Task<Result> DeleteTrans(ShomaranApiMode ApiMode, string factno, int year)
        {
            ...
            var _content = new StringContent(DataJson, Encoding.UTF8, "application/json");
            Result apiresult = await Send.PostAsync(_content, $"ShomaranPetco/DeleteTrans/{factno}/{year}", shomaranApi, ApplicationType.None);
            return apiresult;
        }
