...
{
    public class Form_1005Base : Form_1005Peropeties
    {
        // Toast  
        [Inject]
        ...
        public override async Task<bool> FormValidator()
        {
            ...
            // SequenceFlow_0eev7zv - دکمه ثبت و ادامه
            if (BtnWorkFlowId == "SequenceFlow_0eev7zv") // ProcessID = 923			
            {
        ...
        public async Task<bool> CheckFieldValidation(Entity.SCM_ProductRequestDetails Item)
        {
            ...
            if (Item.Global_SCMRequestTypeId.ToString() == "a9c5df1c-d99c-ef11-8354-005056a02a64" || // تحویل کالا
                Item.Global_SCMRequestTypeId.ToString() == "73f6c459-d99c-ef11-8354-005056a02a64")   // تحویل و خرید کالا
            {
