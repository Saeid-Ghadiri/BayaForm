...
namespace Forms.Forms
{
    public class Form_964_CUBase : Form_964_CUPeropeties
    {
		...
		public async Task  ProductSearch_onitemselected(dynamic Selected ,Entity.SH_PolFilm_FactBuyDetail Item  )
        {
		...
		public async Task  GridSH_PolFilm_FACTBUYId_710_afterrendermodal(Entity.SH_PolFilm_FactBuyDetail Item   )
        {
            if (Item.YEAR == null)
            {
                var pc = new PersianCalendar();
                ...
                Ref_SH_PolFilm_FactBuyDetail_YEAR.Value = Convert.ToInt16(persianYear);
            }
            
            
            if (_Entity.FACTNO == null)
            {
                Ref_SH_PolFilm_FactBuyDetail_ROW_ID.Value = _Entity.SH_PolFilm_FactBuyDetail.Count() + 1;
            }
