...
{
    public class Form_1053_CUBase : Form_1053_CUPeropeties
    {
    ...
    protected override async Task OnAfterRenderAsync(bool firstRender)
    {
        if (firstRender)
        {
                ...
                await JS.InvokeVoidAsync("AddClass", "#btn_listi_Save", "d-none");
				await JS.InvokeVoidAsync("AddClass", "#btn_listi_Save_close", "d-none");
