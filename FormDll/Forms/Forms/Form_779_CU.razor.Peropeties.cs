...
{
    public class Form_779_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_ApprovalsMinistryLaborGroup? _Entity { get; set; } = new Entity.HR_CVR_ApprovalsMinistryLaborGroup();
...
public Input<string?> Ref_CalculationStartYear;
public Input<string?> Ref_CalculationStartMonth;
public Input<string?> Ref_CalculationStartDay;
public Input<int?> Ref_MinimumSalaryMinistryLabor;
public Input<int?> Ref_SalaryMinistryLabor;
public Input<int?> Ref_MinimumSalaryInGroup;
public Input<int?> Ref_SalaryInGroup;
public Input<int?> Ref_MinistryLabourRightHousing;
public Input<int?> Ref_RightHousingGroup;
public Input<int?> Ref_BenKargariMinistryLabor;
public Input<int?> Ref_BenKargariGroup;
public Input<int?> Ref_MinistryLaborRightFood;
public Input<int?> Ref_RightFoodGroup;
public Input<int?> Ref_RightMarryMinistryLabor;
public Input<int?> Ref_RightMarryGroup;
public Input<int?> Ref_ChildrensRightsMinistryLabor;
public Input<int?> Ref_ChildrenRightsGroup;
public Input<decimal?> Ref_CoefficientDurabilityPost;
public Input<short?> Ref_MaximumScoreCoefficientDifficultAndHarmfulJobs;
