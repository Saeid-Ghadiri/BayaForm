...
{
    public class Form_1080_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_ATLASCELL_FACTBUY? _Entity { get; set; } = new Entity.SH_ATLASCELL_FACTBUY();
...
public DxGrid? Grid_SH_ATLASCELL_FactBuyDetail;

public Dropdown Ref_SH_ATLASCELL_FactBuyDetail_ProductSearch;
public Input<string?> Ref_SH_ATLASCELL_FactBuyDetail_ProductName;
public Input<string?> Ref_SH_ATLASCELL_FactBuyDetail_ProductUnit;
public Input<string?> Ref_SH_ATLASCELL_FactBuyDetail_PARTCODE;
public Input<decimal?> Ref_SH_ATLASCELL_FactBuyDetail_AMOUNT;
public Input<string?> Ref_SH_ATLASCELL_FactBuyDetail_RADYABI;
public Input<string?> Ref_SH_ATLASCELL_FactBuyDetail_SEFARESH;
public Input<int?> Ref_SH_ATLASCELL_FactBuyDetail_ROW_ID;
public Input<int?> Ref_SH_ATLASCELL_FactBuyDetail_YEAR;
public Input<string?> Ref_SH_ATLASCELL_FactBuyDetail_NoteD;
public Input<string?> Ref_SH_ATLASCELL_FactBuyDetail_ShomareFani;
public Dropdown Ref_SH_ATLASCELL_FactBuyDetail_SH_ATLASCELL_FACTBUYId;
