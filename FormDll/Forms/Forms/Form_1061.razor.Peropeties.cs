...
{
    public class Form_1061Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.ITIL_RequestType> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.ITIL_RequestType())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1061_CU RefForm { get; set; }
    public Form_1061_Filter RefListFilter  { get; set; }

public DxGrid? Grid_ITIL_RequestType;
