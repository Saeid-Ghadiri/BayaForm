...
{
    public class Form_1104Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMNFP_Attribute> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMNFP_Attribute())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1104_CU RefForm { get; set; }
    public Form_1104_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMNFP_Attribute;
