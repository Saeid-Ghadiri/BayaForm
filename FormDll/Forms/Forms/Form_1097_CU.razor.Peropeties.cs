...
{
    public class Form_1097_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMATLASCELL_PurchaseStage? _Entity { get; set; } = new Entity.SCMATLASCELL_PurchaseStage();
...
public Input<double?> Ref_StagePurchasedQuantity;
