...
{
    public class Form_1021Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SH_Petco_ProductDelivery> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SH_Petco_ProductDelivery())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1021_CU RefForm { get; set; }
    public Form_1021_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SH_Petco_ProductDelivery;
