...
{
    public class Form_1046Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_CVR_GroupVerdict> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_CVR_GroupVerdict())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1046_CU RefForm { get; set; }
    public Form_1046_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_CVR_GroupVerdict;
