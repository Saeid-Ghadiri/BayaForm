...
{
    public class Form_1079_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_ATLASCELL_Anbord? _Entity { get; set; } = new Entity.SH_ATLASCELL_Anbord();
...
public DxGrid? Grid_SH_ATLASCELL_AnbordDetail;

public Dropdown Ref_SH_ATLASCELL_AnbordDetail_ProductSearch;
public Input<string?> Ref_SH_ATLASCELL_AnbordDetail_ProductName;
public Input<string?> Ref_SH_ATLASCELL_AnbordDetail_ShomareFani;
public Input<string?> Ref_SH_ATLASCELL_AnbordDetail_TECDESC;
public Input<string?> Ref_SH_ATLASCELL_AnbordDetail_ProductUnit;
public Input<int?> Ref_SH_ATLASCELL_AnbordDetail_OKAMOUNT;
public Input<int?> Ref_SH_ATLASCELL_AnbordDetail_ORDAMOUNT;
public Input<int?> Ref_SH_ATLASCELL_AnbordDetail_Year;
public Input<string?> Ref_SH_ATLASCELL_AnbordDetail_DESC1;
public Input<string?> Ref_SH_ATLASCELL_AnbordDetail_PARTCODE;
public Input<string?> Ref_SH_ATLASCELL_AnbordDetail_RowId;
public Dropdown Ref_SH_ATLASCELL_AnbordDetail_SH_ATLASCELL_AnbordId;
