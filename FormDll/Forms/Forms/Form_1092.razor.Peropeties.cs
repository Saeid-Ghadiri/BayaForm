...
{
    public class Form_1092Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMATLASCELL_Procurement> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMATLASCELL_Procurement())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1092_CU RefForm { get; set; }
    public Form_1092_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMATLASCELL_Procurement;
