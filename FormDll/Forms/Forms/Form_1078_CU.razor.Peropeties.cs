...
{
    public class Form_1078_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_ATLASCELL_ProductDelivery? _Entity { get; set; } = new Entity.SH_ATLASCELL_ProductDelivery();
...
public Dropdown Ref_CENTCODE2;
public Input<string?> Ref_CREATOR;
public Input<string?> Ref_FACTDATE;
public Input<string?> Ref_FACTNO;
public RadioBoolean Ref_H_KIND;
public Dropdown Ref_INVCODE;
public Input<string?> Ref_TEMPNO;
public Input<string?> Ref_NOTE;
public Input<int?> Ref_Year;
public Dropdown Ref_Havale_List;
public Input<string?> Ref_ApiResult;
public DxGrid? Grid_SH_ATLASCELL_ProductDeliveryDetail;

public Dropdown Ref_SH_ATLASCELL_ProductDeliveryDetail_ProductSearch;
public Input<string?> Ref_SH_ATLASCELL_ProductDeliveryDetail_PARTCODE;
public Input<string?> Ref_SH_ATLASCELL_ProductDeliveryDetail_shomarefani;
public Input<string?> Ref_SH_ATLASCELL_ProductDeliveryDetail_ProductName;
public Input<string?> Ref_SH_ATLASCELL_ProductDeliveryDetail_Unit;
public Dropdown Ref_SH_ATLASCELL_ProductDeliveryDetail_CENTCODE3;
public Input<decimal?> Ref_SH_ATLASCELL_ProductDeliveryDetail_AMOUNT;
public Input<decimal?> Ref_SH_ATLASCELL_ProductDeliveryDetail_AMOUNT2;
public Input<string?> Ref_SH_ATLASCELL_ProductDeliveryDetail_RADYABI;
public Input<string?> Ref_SH_ATLASCELL_ProductDeliveryDetail_SEFARESH;
public Input<int?> Ref_SH_ATLASCELL_ProductDeliveryDetail_ROW_ID;
public Input<int?> Ref_SH_ATLASCELL_ProductDeliveryDetail_Year;
public Dropdown Ref_SH_ATLASCELL_ProductDeliveryDetail_SH_ATLASCELL_ProductDeliveryId;
