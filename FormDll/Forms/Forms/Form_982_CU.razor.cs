...
namespace Forms.Forms
{
    public class Form_982_CUBase : Form_982_CUPeropeties
    {
        ...
        public async Task ProductSearch_onitemselected(dynamic Selected, Entity.Shomaran_ReturnHavaleDetail Item)
        {
            /// <summary>
        ...
        public async Task GridShomaran_ReturnHavaleId_731_afterrendermodal(Entity.Shomaran_ReturnHavaleDetail Item)
        {
            if (Item.Year == null)
            {
                var pc = new PersianCalendar();
                ...
                Ref_Shomaran_ReturnHavaleDetail_Year.Value = persianYear;
            }


            if (_Entity.FactNo == null)
            {
                Ref_Shomaran_ReturnHavaleDetail_RowOrder.Value = _Entity.Shomaran_ReturnHavaleDetail.Count() + 1;
            }
