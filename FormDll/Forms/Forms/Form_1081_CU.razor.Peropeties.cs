...
{
    public class Form_1081_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_ATLASCELL_DepoIn? _Entity { get; set; } = new Entity.SH_ATLASCELL_DepoIn();
...
public Input<string?> Ref_RecNo;
public Input<string?> Ref_RecDate;
...
public Dropdown Ref_Outsourcing_List;
public DxGrid? Grid_SH_ATLASCELL_DepoInDetail;

public Dropdown Ref_SH_ATLASCELL_DepoInDetail_ProductSearch;
public Input<string?> Ref_SH_ATLASCELL_DepoInDetail_ProductName;
public Input<string?> Ref_SH_ATLASCELL_DepoInDetail_Unit;
public Input<string?> Ref_SH_ATLASCELL_DepoInDetail_ShomareFani;
public Input<string?> Ref_SH_ATLASCELL_DepoInDetail_PartCode;
public Input<string?> Ref_SH_ATLASCELL_DepoInDetail_Radyabi;
public Input<string?> Ref_SH_ATLASCELL_DepoInDetail_Sefaresh;
public Input<string?> Ref_SH_ATLASCELL_DepoInDetail_RowId;
public Input<int?> Ref_SH_ATLASCELL_DepoInDetail_Year;
public Input<string?> Ref_SH_ATLASCELL_DepoInDetail_Note;
public Input<decimal?> Ref_SH_ATLASCELL_DepoInDetail_Amount;
public Dropdown Ref_SH_ATLASCELL_DepoInDetail_SH_ATLASCELL_DepoInId;
