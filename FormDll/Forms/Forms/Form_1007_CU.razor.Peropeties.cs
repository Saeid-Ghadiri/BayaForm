...
{
    public class Form_1007_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.IDMS_Products? _Entity { get; set; } = new Entity.IDMS_Products();
...
public Dropdown Ref_IDMS_ProductTypesId;
