...
{
    public class Form_1046_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_GroupVerdict? _Entity { get; set; } = new Entity.HR_CVR_GroupVerdict();
...
public Input<int?> Ref_GroupVerdictNumber;
public Input<string?> Ref_GroupVerdictTitle;
public Input<string?> Ref_GroupVerdictDate_Fa;
public Input<DateTime?> Ref_GroupVerdictDate;
public Input<string?> Ref_GroupVerdictDescription;
