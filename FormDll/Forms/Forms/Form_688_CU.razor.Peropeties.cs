...
{
    public class Form_688_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_Base_BankAccount? _Entity { get; set; } = new Entity.HR_Base_BankAccount();
...
public Dropdown Ref_HR_Base_AccountHolderTypeId;
...
public Dropdown Ref_BaseInfo_BankBranchesId;
