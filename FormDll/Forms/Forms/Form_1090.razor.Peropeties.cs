...
{
    public class Form_1090Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMATLASCELL_ICT_Departments> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMATLASCELL_ICT_Departments())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1090_CU RefForm { get; set; }
    public Form_1090_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMATLASCELL_ICT_Departments;
