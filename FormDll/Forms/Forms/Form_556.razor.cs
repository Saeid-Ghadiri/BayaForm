...
{
    public class Form_556Base : Form_556Peropeties
    {
    ...
    public override async Task<bool> FormValidator()
    {
       bool IsValid = true;
            ...
            // دکمه ثبت و ادامه           
            if (BtnWorkFlowId == "SequenceFlow_0f9c2wp")
            {
            ...
            // لغو کلی درخواست
            if (BtnWorkFlowId == "SequenceFlow_05swfff")
            {
    ...
    public async Task<bool> CheckFieldValidation(Entity.SCM_OS_Details Item)
 		{
            ...
            // استعلام مدیر کارخانه
            if (Item.FM_ConfirmedInquiryNum == null)
		    {
                IsValid = true;

			toastService.ShowError("لطفا گزینه استعلام مورد تایید مدیر کارخانه را تکمیل نمایید.",
			settings => {
				settings.Timeout = 4;
