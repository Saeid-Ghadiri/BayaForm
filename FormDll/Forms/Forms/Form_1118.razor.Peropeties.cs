...
{
    public class Form_1118Peropeties : FormBase
    {
...
public RadioBoolean Ref_SCMNFP_ProductRequestDetails_ConfirmWareHouse;
public Input<string?> Ref_SCMNFP_ProductRequestDetails_WarehouseDescription;
