...
{
    public class Form_1086_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_ATLASCELL_ReturnHavale? _Entity { get; set; } = new Entity.SH_ATLASCELL_ReturnHavale();
...
public DxGrid? Grid_SH_ATLASCELL_ReturnHavaleDetail;

public Dropdown Ref_SH_ATLASCELL_ReturnHavaleDetail_ProductSearch;
public Input<string?> Ref_SH_ATLASCELL_ReturnHavaleDetail_PartCode;
public Input<string?> Ref_SH_ATLASCELL_ReturnHavaleDetail_ShomareFani;
public Input<string?> Ref_SH_ATLASCELL_ReturnHavaleDetail_ProductName;
public Input<string?> Ref_SH_ATLASCELL_ReturnHavaleDetail_Unit;
public Input<decimal?> Ref_SH_ATLASCELL_ReturnHavaleDetail_Amount;
public Input<string?> Ref_SH_ATLASCELL_ReturnHavaleDetail_Radyabi;
public Input<string?> Ref_SH_ATLASCELL_ReturnHavaleDetail_Sefaresh;
public Input<int?> Ref_SH_ATLASCELL_ReturnHavaleDetail_RowOrder;
public Input<int?> Ref_SH_ATLASCELL_ReturnHavaleDetail_Year;
public Dropdown Ref_SH_ATLASCELL_ReturnHavaleDetail_SH_ATLASCELL_ReturnHavaleId;
