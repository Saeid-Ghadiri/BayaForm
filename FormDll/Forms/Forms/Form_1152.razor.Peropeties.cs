...
{
    public class Form_1152Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMATLASCELL_OS_ResultingFrom> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMATLASCELL_OS_ResultingFrom())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1152_CU RefForm { get; set; }
    public Form_1152_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMATLASCELL_OS_ResultingFrom;
