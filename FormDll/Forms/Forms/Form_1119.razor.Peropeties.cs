...
{
    public class Form_1119Peropeties : FormBase
    {
...
public RadioBoolean Ref_IDMS_TestModel_NeedRetest;
public RadioBoolean Ref_IDMS_TestModel_NeedNewTest;
public Input<string?> Ref_IDMS_TestModel_NewTestDefinition;
