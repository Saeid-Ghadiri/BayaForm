...
{
    public class Form_1072Peropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.ITIL_Request? _Entity { get; set; } = new Entity.ITIL_Request();
...
public DxGrid? Grid_ITIL_RequestDetail;

public Dropdown Ref_ITIL_RequestDetail_ITIL_RequestTypeId;
public Dropdown Ref_ITIL_RequestDetail_ITIL_RequestProblemId;
public Dropdown Ref_ITIL_RequestDetail_ITIL_OperationId;
public Input<string?> Ref_ITIL_RequestDetail_Description;
public Input<int?> Ref_ITIL_RequestDetail_ProblemSolver;
public Input<int?> Ref_ITIL_RequestDetail_ProccessLevel;
public Input<int?> Ref_ITIL_RequestDetail_ParentCode;
public Input<Guid?> Ref_ITIL_RequestDetail_RequestID;
public Input<Guid?> Ref_ITIL_RequestDetail_CreateUser;
public Input<Guid?> Ref_ITIL_RequestDetail_UpdateUser;
public Input<DateTime?> Ref_ITIL_RequestDetail_CreateDate;
public Input<DateTime?> Ref_ITIL_RequestDetail_UpdateDate;
public Input<bool?> Ref_ITIL_RequestDetail_IsDelete;
public Input<Guid> Ref_ITIL_RequestDetail_Id;
