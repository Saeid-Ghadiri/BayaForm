...
{
    public class Form_1030_CUBase : Form_1030_CUPeropeties
    {
    ...
    public override async Task AfterGetData()
    {
        ...
        public async Task<bool> UpdateSefareshPoint()
        {
            ...
            if (_Entity._IdIsEmpty.Value)
            {
                ...
                var data = await ApiServer.External.Services.ShomaranPart.UpdateSefaresh2(ShomaranApiMode.Petco, rethavData);
        ...
        public async Task ProductSearch_onitemselected(dynamic Selected)
        {
            /// <summary>
            ...
            //  نام کالا
            _Entity.ProductName = Selected.desc;
            //Console.WriteLine(Selected.DESC);
            //  نام دسته بندی فرعی
            //_Entity.shomarefani = Selected.partno;

            // کد کالا
            _Entity.PartNo = Selected.partcode;
            //واحد کالا
            _Entity.Unit = Selected.unit;
            _Entity.Unit1 = Selected.unit1;


            //شماره فنی کالا
            _Entity.TecNO = Selected.tecno;
