...
{
    public class Form_1062Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.ITIL_RequestProblem> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.ITIL_RequestProblem())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1062_CU RefForm { get; set; }
    public Form_1062_Filter RefListFilter  { get; set; }

public DxGrid? Grid_ITIL_RequestProblem;
