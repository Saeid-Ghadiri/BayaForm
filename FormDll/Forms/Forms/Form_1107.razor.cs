...
{
    public class Form_1107Base : Form_1107Peropeties
    {
        ...
        public async Task ProductName_NotMapped_onitemselected(dynamic Selected, Entity.SCMNFP_ProductRequestDetails Item)
        {
            ...
            {
                //Item.LotNumber =visibl true;
                Ref_SCMNFP_ProductRequestDetails_LotNumber.SetDisabled(false);
            }
            else
            {
        ...
        public async Task GridSCMNFP_ProductRequestId_228_afterrendermodal(Entity.SCMNFP_ProductRequestDetails Item)
        {
            Ref_SCMNFP_ProductRequestDetails_LotNumber.SetDisabled(true);
