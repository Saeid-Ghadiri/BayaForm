...
namespace Forms.Forms
{
    public class Form_978_CUBase : Form_978_CUPeropeties
    {
        ...
        public async Task GridShomaran_DepoOutId_723_afterrendermodal(Entity.Shomaran_DepoOutDetail Item)
        {
            if(Item.Year == null)
            {
                var pc = new PersianCalendar();
                ...
                Ref_Shomaran_DepoOutDetail_Year.Value = persianYear;
            }
           

            if (_Entity.Havno == null)
            {
                Ref_Shomaran_DepoOutDetail_RowId.Value = (_Entity.Shomaran_DepoOutDetail.Count() + 1).ToString();
            }
        }
