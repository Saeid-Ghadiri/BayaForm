...
{
    public class Form_1087Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SH_ATLASCELL_SefareshPoint> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SH_ATLASCELL_SefareshPoint())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1087_CU RefForm { get; set; }
    public Form_1087_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SH_ATLASCELL_SefareshPoint;
