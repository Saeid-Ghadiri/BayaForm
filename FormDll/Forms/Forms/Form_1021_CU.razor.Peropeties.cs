...
{
    public class Form_1021_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_Petco_ProductDelivery? _Entity { get; set; } = new Entity.SH_Petco_ProductDelivery();
...
public Input<int?> Ref_SH_Petco_ProductDeliveryDetail_AMOUNT;
public Input<int?> Ref_SH_Petco_ProductDeliveryDetail_AMOUNT2;
