...
{
    public class Form_1160Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPLATE_OS_ResultingFrom> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPLATE_OS_ResultingFrom())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1160_CU RefForm { get; set; }
    public Form_1160_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPLATE_OS_ResultingFrom;
