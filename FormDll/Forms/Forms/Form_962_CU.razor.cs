...
namespace Forms.Forms
{
    public class Form_962_CUBase : Form_962_CUPeropeties
    {
        ...
        public async Task ProductSearch_onitemselected(dynamic Selected, Entity.SH_PolFilm_AnbordDetail Item)
        {
            /// <summary>
        ...
        public async Task GridSH_PolFilm_AnbordId_708_afterrendermodal(Entity.SH_PolFilm_AnbordDetail Item)
        {
            if (Item.Year == null)
            {
                var pc = new PersianCalendar();
                ...
                Ref_SH_PolFilm_AnbordDetail_Year.Value = persianYear;
            }
            
            if (_Entity.ORDERNO == null)
            {
                Ref_SH_PolFilm_AnbordDetail_RowId.Value = (_Entity.SH_PolFilm_AnbordDetail.Count() + 1).ToString();
            }
