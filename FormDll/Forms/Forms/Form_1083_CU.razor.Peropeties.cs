...
{
    public class Form_1083_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_ATLASCELL_Annarr? _Entity { get; set; } = new Entity.SH_ATLASCELL_Annarr();
...
public DxGrid? Grid_SH_ATLASCELL_AnnarrDetail;

public Dropdown Ref_SH_ATLASCELL_AnnarrDetail_ProductSearch;
public Input<string?> Ref_SH_ATLASCELL_AnnarrDetail_PARTCODE;
public Input<string?> Ref_SH_ATLASCELL_AnnarrDetail_ProductName;
public Input<string?> Ref_SH_ATLASCELL_AnnarrDetail_ShomareFani;
public Input<string?> Ref_SH_ATLASCELL_AnnarrDetail_Unit;
public Input<decimal?> Ref_SH_ATLASCELL_AnnarrDetail_ARRAMOUNT;
public Input<string?> Ref_SH_ATLASCELL_AnnarrDetail_RADYABI;
public Input<string?> Ref_SH_ATLASCELL_AnnarrDetail_SEFARESH;
public Input<string?> Ref_SH_ATLASCELL_AnnarrDetail_RowId;
public Input<int?> Ref_SH_ATLASCELL_AnnarrDetail_YEAR;
public Input<string?> Ref_SH_ATLASCELL_AnnarrDetail_DESC2;
public Dropdown Ref_SH_ATLASCELL_AnnarrDetail_SH_ATLASCELL_AnnarrId;
