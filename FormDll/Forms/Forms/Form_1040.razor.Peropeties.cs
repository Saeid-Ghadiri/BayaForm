...
{
    public class Form_1040Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_HR_Base_BankAcountCategory> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_HR_Base_BankAcountCategory())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1040_CU RefForm { get; set; }
    public Form_1040_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_HR_Base_BankAcountCategory;
