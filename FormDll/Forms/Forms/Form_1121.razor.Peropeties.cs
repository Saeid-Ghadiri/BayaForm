...
{
    public class Form_1121Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMNFP_CostCenter> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMNFP_CostCenter())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1121_CU RefForm { get; set; }
    public Form_1121_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMNFP_CostCenter;
