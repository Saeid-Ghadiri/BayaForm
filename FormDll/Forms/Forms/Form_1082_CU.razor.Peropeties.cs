...
{
    public class Form_1082_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_ATLASCELL_DepoOut? _Entity { get; set; } = new Entity.SH_ATLASCELL_DepoOut();
...
public Dropdown Ref_DepoOut_List;
public DxGrid? Grid_SH_ATLASCELL_DepoOutDetail;

public Input<decimal?> Ref_SH_ATLASCELL_DepoOutDetail_AMOUNT;
public Dropdown Ref_SH_ATLASCELL_DepoOutDetail_InvCode;
public Input<string?> Ref_SH_ATLASCELL_DepoOutDetail_PartCode;
public Input<string?> Ref_SH_ATLASCELL_DepoOutDetail_Radyabi;
public Input<string?> Ref_SH_ATLASCELL_DepoOutDetail_Sefaresh;
public Input<string?> Ref_SH_ATLASCELL_DepoOutDetail_RowId;
public Input<int?> Ref_SH_ATLASCELL_DepoOutDetail_Year;
public Input<string?> Ref_SH_ATLASCELL_DepoOutDetail_NoteD;
public Dropdown Ref_SH_ATLASCELL_DepoOutDetail_ProductSearch;
public Input<string?> Ref_SH_ATLASCELL_DepoOutDetail_shomarefani;
public Input<string?> Ref_SH_ATLASCELL_DepoOutDetail_ProductName;
public Input<string?> Ref_SH_ATLASCELL_DepoOutDetail_Unit;
public Dropdown Ref_SH_ATLASCELL_DepoOutDetail_SH_ATLASCELL_DepoOutId;
