...
{
    public class Form_1062_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.ITIL_RequestProblem? _Entity { get; set; } = new Entity.ITIL_RequestProblem();
...
public Input<string?> Ref_ProblemName;
public Input<int?> Ref_ParentCode;
public Input<int?> Ref_ProblemSolver;
public Input<string?> Ref_ProblemSolverName;
public Input<int?> Ref_ProccessLevel;
public Input<string?> Ref_ProccessLevelName;
