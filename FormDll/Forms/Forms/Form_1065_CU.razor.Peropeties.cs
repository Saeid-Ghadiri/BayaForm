...
{
    public class Form_1065_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.ITIL_RequestDetail? _Entity { get; set; } = new Entity.ITIL_RequestDetail();
...
public Dropdown Ref_ITIL_RequestTypeId;
public Dropdown Ref_ITIL_RequestProblemId;
public Dropdown Ref_ITIL_OperationId;
