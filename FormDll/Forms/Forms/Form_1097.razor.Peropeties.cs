...
{
    public class Form_1097Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMATLASCELL_PurchaseStage> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMATLASCELL_PurchaseStage())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1097_CU RefForm { get; set; }
    public Form_1097_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMATLASCELL_PurchaseStage;
