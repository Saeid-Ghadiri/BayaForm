...
namespace Forms.Forms
{
    public class Form_980_CUBase : Form_980_CUPeropeties
    {
        ...
        public async Task ProductSearch_onitemselected(dynamic Selected, Entity.Shomaran_TransDetail Item)
        {
            /// <summary>
        ...
        public async Task GridShomaran_TransId_727_afterrendermodal(Entity.Shomaran_TransDetail Item)
        {
            if (Item.Year == null)
            {
                var pc = new PersianCalendar();
                ...
                Ref_Shomaran_TransDetail_Year.Value = persianYear;
            }


            if (_Entity.FactNo == null)
            {
                Ref_Shomaran_TransDetail_RowOrder.Value = (_Entity.Shomaran_TransDetail.Count() + 1).ToString();
            }
