...
{
    public class Form_1061_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.ITIL_RequestType? _Entity { get; set; } = new Entity.ITIL_RequestType();
...
public Input<string?> Ref_SoftwareHardware;
