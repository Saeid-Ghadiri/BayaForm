...
{
    public class Form_1116Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.IDMS_TesterRequests> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.IDMS_TesterRequests())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1116_CU RefForm { get; set; }
    public Form_1116_Filter RefListFilter  { get; set; }

public DxGrid? Grid_IDMS_TesterRequests;
