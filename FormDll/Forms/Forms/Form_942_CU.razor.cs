...
{
    public class Form_942_CUBase : Form_942_CUPeropeties
    {
        ...
        public async Task<bool> AddFactBuy()
        {
            ...
            {
                //// ثبت
                var factbuyDetails = _Entity.Shomaran_FactBuyDetail.Select(p => new FactbuyDetailDto()
                {
                ...
                var data = await ApiServer.External.Services.ShomaranPart.CreateFactBuy(ShomaranApiMode.Polfilm, factbuyData);
            ...
            else
            {
                ...
                var data = await ApiServer.External.Services.ShomaranPart.UpdateFactBuy(ShomaranApiMode.Polfilm, factBuyData);
...
namespace ApiServer.External.Services
{
    public partial class ShomaranPart
    {
        ...
        public static async Task<Result> UpdateFactBuy(ShomaranApiMode ApiMode, UpdateFactBuyRequest trans)
        {
         ...
         public static async Task<Result> DeleteFactbuy(ShomaranApiMode ApiMode, string factNo, int year)
        {
...
public class FactbuyDto
{
    public int BuyKind { get; set; } = 2;
    ...
    public int PartKind { get; set; } = 1;
    public string? SelerCode { get; set; }
    public string? SelerName { get; set; }
    // Using "SpUser" because "User" can be a reserved keyword.
    public string? SpUser { get; set; } = "WEB";
    public string? TempNo { get; set; }
    public string? Note { get; set; }
    public string? WUser { get; set; } = "WEBSERVICE";
    public int Year { get; set; }
    public List<FactbuyDetailDto> FactbuyDetails { get; set; } = new List<FactbuyDetailDto>();
}

public class FactbuyDetailDto
{
...
public class UpdateFactBuyRequest
{
