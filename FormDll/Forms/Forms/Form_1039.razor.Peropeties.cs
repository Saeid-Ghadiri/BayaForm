...
{
    public class Form_1039Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.Notifications_Notifications> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.Notifications_Notifications())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1039_CU RefForm { get; set; }
    public Form_1039_Filter RefListFilter  { get; set; }

public DxGrid? Grid_Notifications_Notifications;
