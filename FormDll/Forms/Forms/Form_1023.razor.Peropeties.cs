...
{
    public class Form_1023Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SH_Petco_FACTBUY> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SH_Petco_FACTBUY())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1023_CU RefForm { get; set; }
    public Form_1023_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SH_Petco_FACTBUY;
