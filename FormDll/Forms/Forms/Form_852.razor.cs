...
{
    public class Form_852Base : Form_852Peropeties
    {
                ...
                if (Item.Global_ShomaranInfoId.HasValue)
                {
                    if ((Item.Global_ShomaranInfoId.Value.ToString() == "a5b1bc7b-8bb7-ef11-a4fa-005056a2b6bd" && Item.T_FACTNO_GUID.Value == null) ||
                       ...
                       (Item.Global_ShomaranInfoId.Value.ToString() == "0acf6986-8bb7-ef11-a4fa-005056a2b6bd" && Item.FB_FACTNO_GUID.Value == null) ||
                        (Item.Global_ShomaranInfoId.Value.ToString() == "f79ea98c-b6ee-ef11-a4fb-005056a2b6bd" && (Item.T_FACTNO_GUID.Value == null || Item.FB_FACTNO_GUID.Value == null))
                      )
		...
		public async Task <bool> GridSCMPLATE_ProductRequestId_editmodelsaving(object e   )
        {
            ...
            if (Item.Global_ShomaranInfoId.HasValue)
            {
                ...
                //    (Item.Global_ShomaranInfoId.Value.ToString() == "09cf6986-8bb7-ef11-a4fa-005056a2b6bd" && !Item.KH_CENTCODE_GUID.HasValue) ||
                   ...
                   (Item.Global_ShomaranInfoId.Value.ToString() == "f79ea98c-b6ee-ef11-a4fb-005056a2b6bd" && (!Item.FB_FACTNO_GUID.HasValue || !Item.FB_FACTNO_GUID.HasValue))
                  )
                {
                    IsCancelled = true;
        ...
        public async Task  GridSCMPLATE_ProductRequestId_afterrendermodal(Entity.SCMPLATE_ProductRequestDetails Item   )
        {
            ...
            else
            {
                ...
                // حواله مصرف و رسید با هم
                if (Item.Global_SCMRequestTypeId.ToString() == "73f6c459-d99c-ef11-8354-005056a02a64" &&
                    Item.Global_ShomaranInfoId.ToString() == "a5b1bc7b-8bb7-ef11-a4fa-005056a2b6bd")
                {
                    await HavaleMasrafIsVisible(true);
                    await ResidAnbarIsVisible(true);
                }
            ...
            else
            {
                ...
                try
                {
                    ...
                    if (Selected.Id.ToString() == "a5b1bc7b-8bb7-ef11-a4fa-005056a2b6bd")
                    {
                        ...
                        await JS.InvokeVoidAsync("ModalRemoveClass", "#havale_header", "d-none");
                        await JS.InvokeVoidAsync("ModalAddClass", "#resid_header", "d-none");
                    }
                    ...
                    if (Selected.Id.ToString() == "09cf6986-8bb7-ef11-a4fa-005056a2b6bd")
                    {
                        ...
                        await JS.InvokeVoidAsync("ModalAddClass", "#havale_header", "d-none");
                        await JS.InvokeVoidAsync("ModalAddClass", "#resid_header", "d-none");
                    }
                    ...
                    if (Selected.Id.ToString() == "0acf6986-8bb7-ef11-a4fa-005056a2b6bd")
                    {
                        ...
                        await JS.InvokeVoidAsync("ModalAddClass", "#havale_header", "d-none");
                        await JS.InvokeVoidAsync("ModalRemoveClass", "#resid_header", "d-none");
                    }
                    // حواله مصرف و خرید با هم
                    if (Selected.Id.ToString() == "f79ea98c-b6ee-ef11-a4fb-005056a2b6bd")
                    {
                        await HavaleMasrafIsVisible(true);
                        await ResidAnbarIsVisible(true);
