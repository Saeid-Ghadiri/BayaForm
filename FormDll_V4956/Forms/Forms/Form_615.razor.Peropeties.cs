...
{
    public class Form_615Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_Base_DocumentTypes> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_Base_DocumentTypes())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_615_CU RefForm { get; set; }
    public Form_615_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_Base_DocumentTypes;
