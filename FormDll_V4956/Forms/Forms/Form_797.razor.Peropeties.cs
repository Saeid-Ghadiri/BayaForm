...
{
    public class Form_797Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_RMS_Job_Qualifications> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_RMS_Job_Qualifications())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_797_CU RefForm { get; set; }
    public Form_797_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_RMS_Job_Qualifications;
