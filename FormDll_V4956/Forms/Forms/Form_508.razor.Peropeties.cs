...
{
    public class Form_508Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.Global_UploadFiles_File> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.Global_UploadFiles_File())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_508_CU RefForm { get; set; }
    public Form_508_Filter RefListFilter  { get; set; }

public DxGrid? Grid_Global_UploadFiles_File;
