...
{
    public class Form_817Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_HowToKnowCompany> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_HowToKnowCompany())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_817_CU RefForm { get; set; }
    public Form_817_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_HowToKnowCompany;
