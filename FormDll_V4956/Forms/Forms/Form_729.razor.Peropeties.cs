...
{
    public class Form_729Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPLATE_Procurement> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPLATE_Procurement())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_729_CU RefForm { get; set; }
    public Form_729_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPLATE_Procurement;
