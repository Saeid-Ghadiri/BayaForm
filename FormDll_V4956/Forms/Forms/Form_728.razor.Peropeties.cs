...
{
    public class Form_728Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_Base_RelativeSelfSacerific> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_Base_RelativeSelfSacerific())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_728_CU RefForm { get; set; }
    public Form_728_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_Base_RelativeSelfSacerific;
