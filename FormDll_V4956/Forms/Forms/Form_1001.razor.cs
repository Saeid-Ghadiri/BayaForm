...
{
    public class Form_1001Base : Form_1001Peropeties
    {
        ...
        public override async Task<bool> FormValidator()
        {
            ...
            // دکمه ثبت و ادامه           
            if ((BtnWorkFlowId == "SequenceFlow_1owok4s") || (BtnWorkFlowId == "SequenceFlow_07ytx5f") || (BtnWorkFlowId == "SequenceFlow_0jcd0ji") || (BtnWorkFlowId == "SequenceFlow_16cr63n"))
            {
