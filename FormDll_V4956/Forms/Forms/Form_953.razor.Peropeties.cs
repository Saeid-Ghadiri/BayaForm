...
{
    public class Form_953Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_EmploymentOffers> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_EmploymentOffers())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_953_CU RefForm { get; set; }
    public Form_953_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_EmploymentOffers;
