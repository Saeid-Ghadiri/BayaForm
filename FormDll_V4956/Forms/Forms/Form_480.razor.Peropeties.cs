...
{
    public class Form_480Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.Global_SCMRequestType> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.Global_SCMRequestType())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_480_CU RefForm { get; set; }
    public Form_480_Filter RefListFilter  { get; set; }

public DxGrid? Grid_Global_SCMRequestType;
