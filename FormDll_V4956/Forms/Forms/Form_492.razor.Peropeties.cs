...
{
    public class Form_492Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCM_OS_JobTitle> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCM_OS_JobTitle())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_492_CU RefForm { get; set; }
    public Form_492_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCM_OS_JobTitle;
