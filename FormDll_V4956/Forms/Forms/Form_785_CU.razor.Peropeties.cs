...
{
    public class Form_785_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_RMS_FamiliarityForeigLanguages? _Entity { get; set; } = new Entity.HR_RMS_FamiliarityForeigLanguages();
...
public Input<string?> Ref_NameLanguage;
public Input<bool?> Ref_SpecializationLiteraryField;
public Input<bool?> Ref_ExpertiseTechnicalField;
public Input<bool?> Ref_SpecializationBusiness;
public Dropdown Ref_HR_ReadingId;
public Dropdown Ref_HR_TalkId;
public Dropdown Ref_HR_TranslationId;
public Dropdown Ref_HR_LanguageSkillId;
