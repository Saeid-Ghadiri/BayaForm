...
{
    public class Form_578Peropeties : FormBase
    {
...
public Input<string?> Ref_SCM_OS_Details_FirstApproverDesc;
...
public Input<string?> Ref_SCM_OS_Details_TM_ApproverDesc;
