...
{
    public class Form_1006_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.IDMS_ProductCategories? _Entity { get; set; } = new Entity.IDMS_ProductCategories();
...
public Input<double?> Ref_ProductCategoryCode;
public Input<string?> Ref_ProductCategoryTitle;
