...
{
    public class Form_1000Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCM_PurchaseRemainingStatus> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCM_PurchaseRemainingStatus())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1000_CU RefForm { get; set; }
    public Form_1000_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCM_PurchaseRemainingStatus;
