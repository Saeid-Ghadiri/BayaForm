...
{
    public class Form_732Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPLATE_PurchaseStage> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPLATE_PurchaseStage())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_732_CU RefForm { get; set; }
    public Form_732_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPLATE_PurchaseStage;
