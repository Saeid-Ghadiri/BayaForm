...
{
    public class Form_1014_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_PolFilm_ShomaranUsers? _Entity { get; set; } = new Entity.SH_PolFilm_ShomaranUsers();
