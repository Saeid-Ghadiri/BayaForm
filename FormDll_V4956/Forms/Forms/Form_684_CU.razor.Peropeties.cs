...
{
    public class Form_684_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_ORG_SectionTypes? _Entity { get; set; } = new Entity.HR_ORG_SectionTypes();
