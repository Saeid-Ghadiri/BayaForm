...
{
    public class Form_683_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_ORG_Posts? _Entity { get; set; } = new Entity.HR_ORG_Posts();
...
public Input<string?> Ref_PostCode;
public Input<string?> Ref_Title;
public Dropdown Ref_HR_Base_InsuranceJobsId;
public Input<string?> Ref_Description;
public Input<bool?> Ref_State;
