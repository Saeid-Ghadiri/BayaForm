...
{
    public class Form_680_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_ORG_Chart? _Entity { get; set; } = new Entity.HR_ORG_Chart();
...
public Input<int?> Ref_NumberOfApproved;
public Input<int?> Ref_CurrentCount;
public Dropdown Ref_HR_ORG_ChartStatusId;
