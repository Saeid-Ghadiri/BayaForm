...
{
    public class Form_1011Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.test_testsaeid> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.test_testsaeid())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1011_CU RefForm { get; set; }
    public Form_1011_Filter RefListFilter  { get; set; }

public DxGrid? Grid_test_testsaeid;
