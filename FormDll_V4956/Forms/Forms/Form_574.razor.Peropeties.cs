...
{
    public class Form_574Peropeties : FormBase
    {
...
public RadioBoolean Ref_SCMPETCO_ProductRequestDetails_IsEnableNeedNegotiated;
public RadioBoolean Ref_SCMPETCO_ProductRequestDetails_ResultNegotiation;
