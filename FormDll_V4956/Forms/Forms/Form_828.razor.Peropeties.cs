...
{
    public class Form_828Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_StatusVerdictRecruiting> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_StatusVerdictRecruiting())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_828_CU RefForm { get; set; }
    public Form_828_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_StatusVerdictRecruiting;
