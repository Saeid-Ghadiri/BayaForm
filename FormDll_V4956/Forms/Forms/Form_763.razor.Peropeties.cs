...
{
    public class Form_763Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_StatusPersonnelContract> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_StatusPersonnelContract())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_763_CU RefForm { get; set; }
    public Form_763_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_StatusPersonnelContract;
