...
{
    public class Form_962Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SH_PolFilm_Anbord> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SH_PolFilm_Anbord())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_962_CU RefForm { get; set; }
    public Form_962_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SH_PolFilm_Anbord;
