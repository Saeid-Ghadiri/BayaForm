...
{
    public class Form_987_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.test_Version? _Entity { get; set; } = new Entity.test_Version();
...
public Input<string?> Ref_Number;
public Input<string?> Ref_DateTime;
public Input<string?> Ref_Tagirat;
