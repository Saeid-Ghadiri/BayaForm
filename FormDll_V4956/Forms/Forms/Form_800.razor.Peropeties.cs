...
{
    public class Form_800Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_Base_ContactEmployeeRelative> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_Base_ContactEmployeeRelative())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_800_CU RefForm { get; set; }
    public Form_800_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_Base_ContactEmployeeRelative;
