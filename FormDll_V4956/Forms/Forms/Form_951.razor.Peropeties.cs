...
{
    public class Form_951Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.Shomaran_PSOURCE> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.Shomaran_PSOURCE())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_951_CU RefForm { get; set; }
    public Form_951_Filter RefListFilter  { get; set; }

public DxGrid? Grid_Shomaran_PSOURCE;
