...
{
    public class Form_991_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_LaborCouncilFixedValues? _Entity { get; set; } = new Entity.HR_CVR_LaborCouncilFixedValues();
...
public Input<decimal?> Ref_FixedNumberValueMinistryLabor;
public Input<decimal?> Ref_FixedNumberValueGroup;
