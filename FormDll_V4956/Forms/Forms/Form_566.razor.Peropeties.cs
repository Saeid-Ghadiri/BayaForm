...
{
    public class Form_566Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.PPCAtlasBobbin_Producer> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.PPCAtlasBobbin_Producer())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_566_CU RefForm { get; set; }
    public Form_566_Filter RefListFilter  { get; set; }

public DxGrid? Grid_PPCAtlasBobbin_Producer;
