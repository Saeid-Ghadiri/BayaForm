...
{
    public class Form_591_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.PPCAtlasBobbin_OrderType? _Entity { get; set; } = new Entity.PPCAtlasBobbin_OrderType();
...
public Input<string?> Ref_OrderTypeName;
