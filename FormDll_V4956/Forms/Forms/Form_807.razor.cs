...
{
    public class Form_807Base : Form_807Peropeties
    {
        ...
        public override async Task<bool> FormValidator()
        {
            ...
            // // لغو کلی درخواست
            // if (BtnWorkFlowId == "SequenceFlow_125ag4n") //904
            // {
            //     string sValue = null;
        ...
        // public async Task  ProductName_NotMapped1_onitemselected(dynamic Selected ,Entity.SCM_ProductRequestDetails Item  )
        // {
        //     Console.WriteLine("Selected ");
        //     Console.WriteLine("Selected.PARTCODE : " + Selected.PARTCODE);
        // }
