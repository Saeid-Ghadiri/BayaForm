...
{
    public class Form_781_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_PercentageWorkExperience? _Entity { get; set; } = new Entity.HR_CVR_PercentageWorkExperience();
...
public Input<string?> Ref_FromYear;
public Input<string?> Ref_ToYear;
public Input<short?> Ref_Score;
