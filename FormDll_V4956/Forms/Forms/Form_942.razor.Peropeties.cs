...
{
    public class Form_942Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.Shomaran_FACTBUY> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.Shomaran_FACTBUY())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_942_CU RefForm { get; set; }
    public Form_942_Filter RefListFilter  { get; set; }

public DxGrid? Grid_Shomaran_FACTBUY;
