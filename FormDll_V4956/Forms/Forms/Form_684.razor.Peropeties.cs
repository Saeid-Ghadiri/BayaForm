...
{
    public class Form_684Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_ORG_SectionTypes> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_ORG_SectionTypes())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_684_CU RefForm { get; set; }
    public Form_684_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_ORG_SectionTypes;
