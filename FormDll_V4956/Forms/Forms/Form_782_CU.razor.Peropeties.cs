...
{
    public class Form_782_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_CeilingRightAttraction? _Entity { get; set; } = new Entity.HR_CVR_CeilingRightAttraction();
...
public Input<short?> Ref_JobWagePercentage;
