...
{
    public class Form_803Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_StatusRecruitmentHiring> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_StatusRecruitmentHiring())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_803_CU RefForm { get; set; }
    public Form_803_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_StatusRecruitmentHiring;
