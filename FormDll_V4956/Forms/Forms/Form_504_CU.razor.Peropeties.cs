...
{
    public class Form_504_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMPETCO_AreaOperation? _Entity { get; set; } = new Entity.SCMPETCO_AreaOperation();
...
public Dropdown Ref_SCMPETCO_OS_Details_SCMPETCO_OS_MasterId;
