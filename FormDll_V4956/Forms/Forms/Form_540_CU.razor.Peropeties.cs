...
{
    public class Form_540_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCM_Procurement? _Entity { get; set; } = new Entity.SCM_Procurement();
...
public Input<string?> Ref_ProcurementExpert;
