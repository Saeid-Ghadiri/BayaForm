...
{
    public class Form_825Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_FamilyRelationship> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_FamilyRelationship())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_825_CU RefForm { get; set; }
    public Form_825_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_FamilyRelationship;
