...
{
    public class Form_567_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.PPCAtlasBobbin_ProductGroup? _Entity { get; set; } = new Entity.PPCAtlasBobbin_ProductGroup();
...
public Input<Guid?> Ref_PPCAtlasBobbin_Product_RequestID;
public Input<Guid?> Ref_PPCAtlasBobbin_Product_CreateUser;
public Input<Guid?> Ref_PPCAtlasBobbin_Product_UpdateUser;
public Input<DateTime?> Ref_PPCAtlasBobbin_Product_CreateDate;
public Input<DateTime?> Ref_PPCAtlasBobbin_Product_UpdateDate;
public Input<bool?> Ref_PPCAtlasBobbin_Product_IsDelete;
public Input<string?> Ref_PPCAtlasBobbin_Product_ProductCode;
