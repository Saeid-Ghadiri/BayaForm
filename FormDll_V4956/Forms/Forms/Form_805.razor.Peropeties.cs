...
{
    public class Form_805Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_StatusHiringtQuestionnaireAnnouncemen> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_StatusHiringtQuestionnaireAnnouncemen())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_805_CU RefForm { get; set; }
    public Form_805_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_StatusHiringtQuestionnaireAnnouncemen;
