...
{
    public class Form_911Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.BaseInfo_MilitaryStatus> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.BaseInfo_MilitaryStatus())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_911_CU RefForm { get; set; }
    public Form_911_Filter RefListFilter  { get; set; }

public DxGrid? Grid_BaseInfo_MilitaryStatus;
