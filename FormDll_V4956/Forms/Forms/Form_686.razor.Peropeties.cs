...
{
    public class Form_686Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_Base_TransportServiceStationsAssign> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_Base_TransportServiceStationsAssign())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_686_CU RefForm { get; set; }
    public Form_686_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_Base_TransportServiceStationsAssign;
