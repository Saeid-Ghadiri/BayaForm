...
{
    public class Form_1009_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.IDMS_ResultingFrom? _Entity { get; set; } = new Entity.IDMS_ResultingFrom();
...
public Input<double?> Ref_ResultingFromCode;
public Input<string?> Ref_ResultingFromTitle;
