...
{
    public class Form_976Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPETCO_SupplierEvaluationModel> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPETCO_SupplierEvaluationModel())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_976_CU RefForm { get; set; }
    public Form_976_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPETCO_SupplierEvaluationModel;
