...
{
    public class Form_789Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_RMS_RecruitmentHiring> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_RMS_RecruitmentHiring())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_789_CU RefForm { get; set; }
    public Form_789_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_RMS_RecruitmentHiring;
