...
{
    public class Form_772_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_EveryPostVerdict? _Entity { get; set; } = new Entity.HR_CVR_EveryPostVerdict();
...
public RadioBoolean Ref_PostType;
public RadioBoolean Ref_SectionsType;
