...
{
    public class Form_925Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.BaseInfo_BankAccountType> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.BaseInfo_BankAccountType())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_925_CU RefForm { get; set; }
    public Form_925_Filter RefListFilter  { get; set; }

public DxGrid? Grid_BaseInfo_BankAccountType;
