...
{
    public class Form_796_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_RMS_JobHistory? _Entity { get; set; } = new Entity.HR_RMS_JobHistory();
...
public Input<string?> Ref_StartWork;
public Input<string?> Ref_EndWork;
public Input<string?> Ref_CompanyName;
public Input<string?> Ref_TypeActivity;
public Input<string?> Ref_LastJobTitle;
public Input<int?> Ref_LastSalary;
public Input<bool?> Ref_HasInsurance;
public Input<string?> Ref_ReasonBreakup;
public Input<string?> Ref_NameDirectManager;
public Input<string?> Ref_WorkPhone;
public Input<string?> Ref_InsuranceTypes;
