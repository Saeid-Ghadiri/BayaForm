...
{
    public class Form_773_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_ItemsVerdictLegal? _Entity { get; set; } = new Entity.HR_ItemsVerdictLegal();
...
public Dropdown Ref_HR_CVR_SalaryPaymentItemsId;
