...
{
    public class Form_634Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_Base_AcademicDegrees> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_Base_AcademicDegrees())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_634_CU RefForm { get; set; }
    public Form_634_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_Base_AcademicDegrees;
