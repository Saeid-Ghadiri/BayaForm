...
{
    public class Form_939Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_JobIntervieweTitle> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_JobIntervieweTitle())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_939_CU RefForm { get; set; }
    public Form_939_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_JobIntervieweTitle;
