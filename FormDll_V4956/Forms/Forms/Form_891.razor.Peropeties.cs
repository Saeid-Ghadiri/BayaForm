...
{
    public class Form_891Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPETCO_TitlePaymentMethod_Supplier> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPETCO_TitlePaymentMethod_Supplier())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_891_CU RefForm { get; set; }
    public Form_891_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPETCO_TitlePaymentMethod_Supplier;
