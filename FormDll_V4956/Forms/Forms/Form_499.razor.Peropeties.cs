...
{
    public class Form_499Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.Global_ShomaranInfo> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.Global_ShomaranInfo())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_499_CU RefForm { get; set; }
    public Form_499_Filter RefListFilter  { get; set; }

public DxGrid? Grid_Global_ShomaranInfo;
