...
{
    public class Form_786_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_RMS_HiringtQuestionnaireAnnouncemen? _Entity { get; set; } = new Entity.HR_RMS_HiringtQuestionnaireAnnouncemen();
...
public Input<string?> Ref_TimeRegisterannouncement;
public Input<string?> Ref_ToDate;
public Dropdown Ref_HR_StatusHiringtQuestionnaireAnnouncemenId;
public Input<string?> Ref_ReasonQuestionnaire;
public Input<Guid> Ref_Id;
public Dropdown Ref_RegisterUserId;
public Input<string?> Ref_ConfirmationTime;
