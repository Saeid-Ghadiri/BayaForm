...
{
    public class Form_414Peropeties : FormBase
    {
...
public Input<string?> Ref_SCMICT_ProductRequestDetails_FMInquiryConfirm;
public Input<string?> Ref_SCMICT_ProductRequestDetails_CEOInquiryConfirm;
