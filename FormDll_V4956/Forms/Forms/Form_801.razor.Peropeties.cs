...
{
    public class Form_801Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_MilitaryServicesExemptionType> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_MilitaryServicesExemptionType())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_801_CU RefForm { get; set; }
    public Form_801_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_MilitaryServicesExemptionType;
