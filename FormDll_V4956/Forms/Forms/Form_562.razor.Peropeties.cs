...
{
    public class Form_562Peropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMPETCO_OS_Master? _Entity { get; set; } = new Entity.SCMPETCO_OS_Master();
...
public Input<string?> Ref_SCMPETCO_OS_Details_FirstApproverDesc;
public Input<string?> Ref_SCMPETCO_OS_Details_SecondApproverDesc;
...
public RadioBoolean Ref_SCMPETCO_OS_Details_GuaranteeIsEnable;
public RadioBoolean Ref_SCMPETCO_OS_Details_HistoryRepairsIsEnable;
public RadioBoolean Ref_SCMPETCO_OS_Details_ITILCodeIsEnable;
public Dropdown Ref_SCMPETCO_OS_Details_ResultingFromITIL;
public Input<string?> Ref_SCMPETCO_OS_Details_RequesterUserITIL;
public Input<string?> Ref_SCMPETCO_OS_Details_CreatedAtITIL;
public Dropdown Ref_SCMPETCO_OS_Details_ITILDetails;
public Input<string?> Ref_SCMPETCO_OS_Details_RequestIdITIL;
