...
{
    public class Form_674_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_Base_TransportService? _Entity { get; set; } = new Entity.HR_Base_TransportService();
...
public Dropdown Ref_HR_Base_TransportServiceTypeId;
