...
{
    public class Form_675_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_Base_University? _Entity { get; set; } = new Entity.HR_Base_University();
...
public Input<decimal?> Ref_Grade;
