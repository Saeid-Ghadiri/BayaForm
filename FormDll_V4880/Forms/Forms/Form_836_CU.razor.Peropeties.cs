...
{
    public class Form_836_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_EMP_EmployeeFamileis? _Entity { get; set; } = new Entity.HR_EMP_EmployeeFamileis();
...
public Input<string?> Ref_SupplementaryInsuranceStartDate;
public Input<string?> Ref_SupplementaryInsuranceEndDate_Fa;
public Input<string?> Ref_SupplementaryInsuranceEndDate;
public Input<bool?> Ref_IsCurrentlyStudying;
public Input<string?> Ref_EducationStartDate_Fa;
public Input<DateTime?> Ref_EducationStartDate;
