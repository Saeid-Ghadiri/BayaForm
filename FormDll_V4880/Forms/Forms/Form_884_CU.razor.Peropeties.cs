...
{
    public class Form_884_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMPETCO_TransportationMethod_Supplier? _Entity { get; set; } = new Entity.SCMPETCO_TransportationMethod_Supplier();
