...
{
    public class Form_282Peropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.FileUploads_FileUploads? _Entity { get; set; } = new Entity.FileUploads_FileUploads();
...
public Input<string?> Ref_FileTitle;
public FileUploadPage.Uploader<Entity.FileUploads_FileUploads_FileUpload> Ref_FileUploads_FileUploads_FileUpload;
