...
{
    public class Form_958_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_PolFilm_ProductDelivery? _Entity { get; set; } = new Entity.SH_PolFilm_ProductDelivery();
...
public Dropdown Ref_SH_PolFilm_ProductDeliveryDetail_PARTCODE;
