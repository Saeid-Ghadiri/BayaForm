...
{
    public class Form_776_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_SalaryHistory? _Entity { get; set; } = new Entity.HR_CVR_SalaryHistory();
...
public Input<int?> Ref_SalaryGroup;
