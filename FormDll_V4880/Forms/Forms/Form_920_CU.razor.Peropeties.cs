...
{
    public class Form_920_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.BaseInfo_BankBranches? _Entity { get; set; } = new Entity.BaseInfo_BankBranches();
...
public Dropdown Ref_BaseInfo_BanksId;
