...
{
    public class Form_778_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_FinalProduct? _Entity { get; set; } = new Entity.HR_CVR_FinalProduct();
...
public Input<short?> Ref_ScoreAffectingProduct;
public Input<short?> Ref_RiskToleranceScore;
public Input<short?> Ref_DecisionMakingScore;
public Input<short?> Ref_ScoreGreatDecisions;
public Input<short?> Ref_DecisionScore;
public Input<short?> Ref_ScoreResponsibilityAndAccountability;
public Input<short?> Ref_ExpertiseScore;
public Input<short?> Ref_ScorePersonalInteractions;
public Input<short?> Ref_ScoreReports;
public Input<int?> Ref_TotalScore;
