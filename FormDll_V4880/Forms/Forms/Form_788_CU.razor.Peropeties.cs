...
{
    public class Form_788_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_RMS_FirstDegreeRelatives? _Entity { get; set; } = new Entity.HR_RMS_FirstDegreeRelatives();
...
public Input<string?> Ref_Job;
public Input<string?> Ref_NameOrganization;
public Input<bool?> Ref_UnderFamilyCare;
