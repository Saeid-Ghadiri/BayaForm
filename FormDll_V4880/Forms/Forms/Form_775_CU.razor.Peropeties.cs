...
{
    public class Form_775_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_JobSalaryRank? _Entity { get; set; } = new Entity.HR_CVR_JobSalaryRank();
...
public Input<string?> Ref_StartDateJobSalaryRank_Fa;
public Input<DateTime?> Ref_StartDateJobSalaryRank;
