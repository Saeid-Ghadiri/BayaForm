...
{
    public class Form_520Base : Form_520Peropeties
    {
    ...
    public override async Task<bool> FormValidator()
    {
		...
		{
            // ConfirmationOfTheInquiryCEO
            if (String.IsNullOrEmpty(Item.ConfirmationOfTheInquiryCEO))
			{
				IsValid = false;
    ...
    public async Task <bool> SCM_ProductRequestDetails_editmodelsaving(object e   )
    {
        ...
        // ConfirmationOfTheInquiryCEO
        if (String.IsNullOrEmpty(DM.ConfirmationOfTheInquiryCEO))
		{
			IsCancelled = true;
