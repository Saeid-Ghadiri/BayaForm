...
{
    public class Form_784_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CRS_ContractTime? _Entity { get; set; } = new Entity.HR_CRS_ContractTime();
...
public Dropdown Ref_HR_ORG_PositionClassificationId;
public Dropdown Ref_HR_EmployeeContractTypeId;
public Dropdown Ref_HR_ContractTimeTypeId;
public Input<byte?> Ref_FromNumber;
public Input<byte?> Ref_ToNumber;
public Input<int?> Ref_ContractTime;
public Input<byte?> Ref_ContractTimeCounter;
public Input<int?> Ref_MonthToDays;
public Input<int?> Ref_ContractTotalDays;
