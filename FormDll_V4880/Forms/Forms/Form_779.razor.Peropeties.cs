...
{
    public class Form_779Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_CVR_ApprovalsMinistryLaborGroup> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_CVR_ApprovalsMinistryLaborGroup())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_779_CU RefForm { get; set; }
    public Form_779_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_CVR_ApprovalsMinistryLaborGroup;
