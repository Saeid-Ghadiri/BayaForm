...
{
    public class Form_777_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_RightGuardianship? _Entity { get; set; } = new Entity.HR_CVR_RightGuardianship();
...
public Dropdown Ref_HR_ORG_PositionsId;
public Input<short?> Ref_DirectScore;
public Input<short?> Ref_IndirectScore;
public Input<decimal?> Ref_RialCoefficient;
