...
{
    public class Form_493Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCM_OS_PlaceofUse> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCM_OS_PlaceofUse())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_493_CU RefForm { get; set; }
    public Form_493_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCM_OS_PlaceofUse;
