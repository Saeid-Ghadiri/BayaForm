...
{
    public class Form_308Base : Form_308Peropeties
    {
    ...
    public override async Task<bool> FormValidator()
    {
        ...
        {
            // توضیحات تایید استعلام دفتر فنی
            if(Item.ConfirmationOfTheInquiryTechnicalOffice == null)
            {
				IsValid = false;
				toastService.ShowError("لطفا گزینه توضیحات تایید استعلام دفتر فنی را تکمیل نمایید.",
				settings => {
					settings.Timeout = 4;
...
return new Result() { Status = HttpStatusCode.OK };
    ...
    public async Task <bool> SCM_ProductRequestDetails_editmodelsaving(object e   )
        ...
        // توضیحات تایید استعلام دفتر فنی
        if(EntityDetail.ConfirmationOfTheInquiryTechnicalOffice == null)
        {
			IsCancelled = true;
			toastService.ShowError("لطفا گزینه توضیحات تایید استعلام دفتر فنی را تکمیل نمایید.",
			settings => {
