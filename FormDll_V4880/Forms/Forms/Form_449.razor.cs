...
{
	public class Form_449Base : Form_449Peropeties
	{
        ...
        if(ListCount==0)
        {
            ...
            "<div>"+
                "<picture>"+
                    "<img src='https://file.workcv.ir/fa/api/v1/File/Get?FileID=66a3abd8-12c1-4281-d6ed-08dcdfbc856d' class='' alt='لوگو پتکو' width='96px;'>"+
                "</picture>"+
                "<hr class='hrdash border-danger-subtle'>"+
            "</div>"+
		...
		public async Task pelatProductSearch_NotMapped_onitemselected(dynamic Selected, Entity.SCMICT_ProductRequestDetails Item)
		{
			///</summary>
...
//                 Item.DeficitSupplyIsEnable = null;
//                 // آیا فرآیند تحویل اجرا گردد؟
//                 Item.GoodsDeliveryIsEnable = null;
//                 // آیا ITIL دارد
