...
{
    public class Form_488Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCM_NumTransfersGoodsWarehouse> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCM_NumTransfersGoodsWarehouse())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_488_CU RefForm { get; set; }
    public Form_488_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCM_NumTransfersGoodsWarehouse;
