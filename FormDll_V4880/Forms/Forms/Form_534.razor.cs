...
{
    public class Form_534Base : Form_534Peropeties
    {
    ...
    public async Task  SCMPETCO_OS_Details_afterrendermodal(Entity.SCMPETCO_OS_Details Item)
    {
        ...
        if (Item.FiveSIsEnable.HasValue && !Item.FiveSIsEnable.Value)
		{
			Ref_SCMPETCO_OS_Details_FiveSDesc.SetVisible(true); 
		}
		else
		{
			Ref_SCMPETCO_OS_Details_FiveSDesc.SetVisible(false); 
		}
    }
	...
	public async Task  UploadFileIsEnable_oninput(ChangeEventArgs Selected ,Entity.SCMPETCO_OS_Details Item)
    {
		...
		public async Task  FiveSIsEnable_oninput(ChangeEventArgs Selected ,Entity.SCMPETCO_OS_Details Item  )
        {
            // FiveSIsEnable
            var FiveSDescIsVisible = Ref_SCMPETCO_OS_Details_FiveSDesc;
