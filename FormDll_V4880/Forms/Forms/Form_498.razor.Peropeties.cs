...
{
    public class Form_498Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCM_ResultingFrom> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCM_ResultingFrom())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_498_CU RefForm { get; set; }
    public Form_498_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCM_ResultingFrom;
