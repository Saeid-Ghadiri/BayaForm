...
{
    public class Form_505Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPETCO_OS_ResultingFrom> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPETCO_OS_ResultingFrom())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_505_CU RefForm { get; set; }
    public Form_505_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPETCO_OS_ResultingFrom;
