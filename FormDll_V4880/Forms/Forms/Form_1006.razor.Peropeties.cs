...
{
    public class Form_1006Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.IDMS_ProductCategories> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.IDMS_ProductCategories())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1006_CU RefForm { get; set; }
    public Form_1006_Filter RefListFilter  { get; set; }

public DxGrid? Grid_IDMS_ProductCategories;
