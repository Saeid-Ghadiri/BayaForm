...
{
    public class Form_899_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMPETCO_QCInspectionReport? _Entity { get; set; } = new Entity.SCMPETCO_QCInspectionReport();
...
public Input<int?> Ref_QCInspectionNo;
