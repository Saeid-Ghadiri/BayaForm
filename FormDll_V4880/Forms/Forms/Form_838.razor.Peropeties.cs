...
{
    public class Form_838Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_EMP_EmployeeFamileisMaster> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_EMP_EmployeeFamileisMaster())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_838_CU RefForm { get; set; }
    public Form_838_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_EMP_EmployeeFamileisMaster;
