...
{
    public class Form_795_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_RMS_EducationalRecords? _Entity { get; set; } = new Entity.HR_RMS_EducationalRecords();
...
public Input<string?> Ref_NameEducationalInstitution;
public Dropdown Ref_HR_Base_UniversityTypeId;
public Input<string?> Ref_FromDate;
public Input<string?> Ref_ToDate;
public Input<double?> Ref_GPA;
public Input<string?> Ref_CityStudy;
public Input<string?> Ref_FieldStudySpecialization;
