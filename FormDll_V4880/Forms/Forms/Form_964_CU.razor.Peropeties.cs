...
{
    public class Form_964_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_PolFilm_FACTBUY? _Entity { get; set; } = new Entity.SH_PolFilm_FACTBUY();
...
public Dropdown Ref_SH_PolFilm_FactBuyDetail_PARTCODE;
