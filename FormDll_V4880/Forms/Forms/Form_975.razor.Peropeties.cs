...
{
    public class Form_975Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPETCO_SupplierEvaluationTitle> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPETCO_SupplierEvaluationTitle())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_975_CU RefForm { get; set; }
    public Form_975_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPETCO_SupplierEvaluationTitle;
