...
{
    public class Form_790Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_RMS_RecruitmentRequests> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_RMS_RecruitmentRequests())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_790_CU RefForm { get; set; }
    public Form_790_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_RMS_RecruitmentRequests;
