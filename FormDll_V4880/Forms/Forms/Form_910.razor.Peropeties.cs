...
{
    public class Form_910Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.BaseInfo_MaritalStatus> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.BaseInfo_MaritalStatus())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_910_CU RefForm { get; set; }
    public Form_910_Filter RefListFilter  { get; set; }

public DxGrid? Grid_BaseInfo_MaritalStatus;
