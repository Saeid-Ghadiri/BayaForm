...
{
    public class Form_470_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.Global_PHB_Main? _Entity { get; set; } = new Entity.Global_PHB_Main();
...
public Dropdown Ref_Users_NotMapped;
...
public Input<string?> Ref_UnitName;
public Input<string?> Ref_SectionName;
public Input<int?> Ref_User_EMP_NO;
public Input<int?> Ref_InternalCodeTel;
public Input<int?> Ref_InternalCodeTe2;
public Input<int?> Ref_InternalCodeTel3;
public Input<int?> Ref_InternalCodeTel4;
public Input<string?> Ref_MobCell;
public Input<string?> Ref_Email;
public Input<string?> Ref_UserId;
