...
{
    public class Form_919_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.BaseInfo_BankType? _Entity { get; set; } = new Entity.BaseInfo_BankType();
...
public DxGrid? Grid_BaseInfo_Banks;

public Input<Guid> Ref_BaseInfo_Banks_Id;
public Input<Guid?> Ref_BaseInfo_Banks_RequestID;
public Input<Guid?> Ref_BaseInfo_Banks_CreateUser;
public Input<Guid?> Ref_BaseInfo_Banks_UpdateUser;
public Input<DateTime?> Ref_BaseInfo_Banks_CreateDate;
public Input<DateTime?> Ref_BaseInfo_Banks_UpdateDate;
public Input<bool?> Ref_BaseInfo_Banks_IsDelete;
public Input<string?> Ref_BaseInfo_Banks_Title;
public Input<string?> Ref_BaseInfo_Banks_CNAPSE_Code;
public Input<bool?> Ref_BaseInfo_Banks_IsActive;
public Input<string?> Ref_BaseInfo_Banks_ExtCode;
public Input<Guid?> Ref_BaseInfo_Banks_BaseInfo_BankType;
