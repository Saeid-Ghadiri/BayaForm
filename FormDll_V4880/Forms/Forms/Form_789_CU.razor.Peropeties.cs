...
{
    public class Form_789_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_RMS_RecruitmentHiring? _Entity { get; set; } = new Entity.HR_RMS_RecruitmentHiring();
...
public Dropdown Ref_HR_RMS_RecruitmentRequestsId;
public Input<int?> Ref_DailyWage;
public Input<byte?> Ref_OccupationalGroup;
public Input<int?> Ref_NetSalaryReceived;
public Input<int?> Ref_DailyAttractionRight;
public Dropdown Ref_HR_CVR_JobId;
public Input<int?> Ref_DailyWorkingEnvironmentConditions;
public Dropdown Ref_HR_StatusRecruitmentHiringId;
public Dropdown Ref_HR_RMS_HiringQuestionnaireId;
public Input<string?> Ref_PersonalityTestResults;
public Input<string?> Ref_ReasonsApproval;
public Dropdown Ref_HR_ORG_SectionsId;
public Dropdown Ref_HR_ORG_PostsId;
public Input<byte?> Ref_ScoreInterviewConfirmation;
public Input<string?> Ref_DescriptionHR;
public Input<string?> Ref_ConfirmTimeDeputyHR;
public Dropdown Ref_HumanResourcesManagerUserId;
public Input<string?> Ref_RegulatingDescription;
public Input<string?> Ref_RegulatingTime;
public Input<string?> Ref_InterviewConfirmationTime;
public Dropdown Ref_ScoreInterviewConfirmationEmployeeId;
public Input<string?> Ref_ApprovalTimeFactoryManager;
public Input<string?> Ref_DescriptionFactoryManager;
public Dropdown Ref_FactoryManagerUserId;
public Input<string?> Ref_DescriptionDeputyHR;
public Dropdown Ref_RequestUserId;
public Input<string?> Ref_LastApproverTime;
public Input<string?> Ref_ApproveTime;
public Dropdown Ref_UnitManagerUserId;
public Input<string?> Ref_DescriptionLastApprover;
public Dropdown Ref_FinalApproverUserId;
