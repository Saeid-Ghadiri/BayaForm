...
{
    public class Form_802_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_StatusExtensionPersonnelContract? _Entity { get; set; } = new Entity.HR_StatusExtensionPersonnelContract();
