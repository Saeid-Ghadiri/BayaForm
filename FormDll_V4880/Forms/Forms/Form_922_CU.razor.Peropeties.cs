...
{
    public class Form_922_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.BaseInfo_Banks? _Entity { get; set; } = new Entity.BaseInfo_Banks();
...
public Dropdown Ref_BaseInfo_BankType;
...
public Input<Guid?> Ref_BaseInfo_BankBranches_RequestID;
public Input<Guid?> Ref_BaseInfo_BankBranches_CreateUser;
public Input<Guid?> Ref_BaseInfo_BankBranches_UpdateUser;
public Input<DateTime?> Ref_BaseInfo_BankBranches_CreateDate;
public Input<DateTime?> Ref_BaseInfo_BankBranches_UpdateDate;
public Input<bool?> Ref_BaseInfo_BankBranches_IsDelete;
public Input<string?> Ref_BaseInfo_BankBranches_Title;
public Input<string?> Ref_BaseInfo_BankBranches_Address;
public Input<string?> Ref_BaseInfo_BankBranches_Code;
