...
{
    public class Form_972Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCM_ICT_Departments> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCM_ICT_Departments())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_972_CU RefForm { get; set; }
    public Form_972_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCM_ICT_Departments;
