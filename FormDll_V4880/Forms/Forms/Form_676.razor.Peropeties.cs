...
{
    public class Form_676Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_EMP_WorkExperiences> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_EMP_WorkExperiences())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_676_CU RefForm { get; set; }
    public Form_676_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_EMP_WorkExperiences;
