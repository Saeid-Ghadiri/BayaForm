...
{
    public class Form_936_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_PersonnelContract? _Entity { get; set; } = new Entity.HR_CVR_PersonnelContract();
...
public Input<string?> Ref_ContractNo;
public Dropdown Ref_HR_CVR_TypeContractId;
public Dropdown Ref_HR_CVR_EmploymentTypeId;
public Input<short?> Ref_HoursPerMonth;
public Dropdown Ref_HR_StatusPersonnelContractId;
public Input<string?> Ref_Description;
public Dropdown Ref_HR_CRS_ContractTimeId;
public Input<short?> Ref_Counter;
public ElementReference Ref_PersonnelContract;
public ElementReference Ref_PersonnelContract1;
...
public Input<string?> Ref_Days_Elapsed;
public Input<string?> Ref_Days_Remaining;
public Input<string?> Ref_Total_Days;
