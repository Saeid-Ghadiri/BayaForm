...
{
    public class Form_802Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_StatusExtensionPersonnelContract> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_StatusExtensionPersonnelContract())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_802_CU RefForm { get; set; }
    public Form_802_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_StatusExtensionPersonnelContract;
