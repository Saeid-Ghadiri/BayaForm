...
{
    public class Form_507Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.FU_FU_Main> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.FU_FU_Main())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_507_CU RefForm { get; set; }
    public Form_507_Filter RefListFilter  { get; set; }

public DxGrid? Grid_FU_FU_Main;
