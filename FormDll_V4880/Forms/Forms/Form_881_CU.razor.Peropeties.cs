...
{
    public class Form_881_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMPETCO_TitlePreAssessment_Supplier? _Entity { get; set; } = new Entity.SCMPETCO_TitlePreAssessment_Supplier();
