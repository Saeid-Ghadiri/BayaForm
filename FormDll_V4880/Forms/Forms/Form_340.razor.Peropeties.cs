...
{
    public class Form_340Peropeties : FormBase
    {
...
public Input<string?> Ref_KH_PAYCENTName;
public Input<string?> Ref_KH_CENTCODE;
public Input<string?> Ref_KH_REQPERSON;
public Input<string?> Ref_KH_WUSER;
public Input<string?> Ref_KH_APPROVER;
public Input<string?> Ref_KH_ORDERDATE;
public Input<string?> Ref_KH_OKFACTDATE;
public Input<string?> Ref_KH_ORDERNO;
public Input<int?> Ref_KHARID_YEAR;
public Dropdown Ref_KH_KharidDTL;
public Input<int?> Ref_KH_TempNoNum;
public Input<string?> Ref_KH_INVCODE;
public Dropdown Ref_TempNoNum_NotMapped;
public Input<string?> Ref_T_FACTNO;
public Input<int?> Ref_T_TempNoNum;
public Input<string?> Ref_T_FACTDATE;
public Input<string?> Ref_T_CREATOR;
...
public Input<Guid?> Ref_KH_CENTCODE_GUID;
