...
{
    public class Form_634_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_Base_AcademicDegrees? _Entity { get; set; } = new Entity.HR_Base_AcademicDegrees();
