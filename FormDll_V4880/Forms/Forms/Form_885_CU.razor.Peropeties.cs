...
{
    public class Form_885_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMPETCO_InspectionMethod_Supplier? _Entity { get; set; } = new Entity.SCMPETCO_InspectionMethod_Supplier();
