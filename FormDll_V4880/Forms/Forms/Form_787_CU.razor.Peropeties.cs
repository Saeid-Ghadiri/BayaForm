...
{
    public class Form_787_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_RMS_InterviewScores? _Entity { get; set; } = new Entity.HR_RMS_InterviewScores();
...
public Dropdown Ref_HR_RMS_RecruitmentHiringId;
public Dropdown Ref_HR_ScoreTypeId;
public Input<string?> Ref_CheckedItems;
public Input<byte?> Ref_Score;
public Input<string?> Ref_ResultReason;
