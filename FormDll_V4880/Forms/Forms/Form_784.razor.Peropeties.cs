...
{
    public class Form_784Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_CRS_ContractTime> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_CRS_ContractTime())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_784_CU RefForm { get; set; }
    public Form_784_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_CRS_ContractTime;
