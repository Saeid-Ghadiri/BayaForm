...
{
    public class Form_914_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.BaseInfo_Countries? _Entity { get; set; } = new Entity.BaseInfo_Countries();
...
public Dropdown Ref_BaseInfo_ContinentsId;
public Input<string?> Ref_PhoneCode;
