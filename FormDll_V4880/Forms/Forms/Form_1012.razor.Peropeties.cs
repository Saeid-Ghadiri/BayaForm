...
{
    public class Form_1012Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.IDMS_TestModelObj> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.IDMS_TestModelObj())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1012_CU RefForm { get; set; }
    public Form_1012_Filter RefListFilter  { get; set; }

public DxGrid? Grid_IDMS_TestModelObj;
