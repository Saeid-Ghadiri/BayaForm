...
{
    public class Form_535Peropeties : FormBase
    {
...
public RadioBoolean Ref_SCMPETCO_OS_Details_FiveSIsEnable;
public Input<string?> Ref_SCMPETCO_OS_Details_FiveSDesc;
