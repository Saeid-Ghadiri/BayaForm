...
{
    public class Form_985Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.Shomaran_Trans> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.Shomaran_Trans())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_985_CU RefForm { get; set; }
    public Form_985_Filter RefListFilter  { get; set; }

public DxGrid? Grid_Shomaran_Trans;
