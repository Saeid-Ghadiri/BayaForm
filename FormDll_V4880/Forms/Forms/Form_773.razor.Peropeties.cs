...
{
    public class Form_773Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_ItemsVerdictLegal> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_ItemsVerdictLegal())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_773_CU RefForm { get; set; }
    public Form_773_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_ItemsVerdictLegal;
