...
{
    public class Form_979Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.Shomaran_Annarr> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.Shomaran_Annarr())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_979_CU RefForm { get; set; }
    public Form_979_Filter RefListFilter  { get; set; }

public DxGrid? Grid_Shomaran_Annarr;
