...
{
    public class Form_565Peropeties : FormBase
    {
...
public Input<string?> Ref_SCMPETCO_OS_Details_DTFA_DeliveryProcurement;
public RadioBoolean Ref_SCMPETCO_OS_Details_IsEnableApproved;
public RadioBoolean Ref_SCMPETCO_OS_Details_IsEnableNeedModified;
