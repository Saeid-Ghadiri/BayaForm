...
{
    public class Form_682_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_ORG_Positions? _Entity { get; set; } = new Entity.HR_ORG_Positions();
...
public Input<string?> Ref_PositionCode;
...
public Input<Guid?> Ref_HR_ORG_Posts_UpdateUser;
