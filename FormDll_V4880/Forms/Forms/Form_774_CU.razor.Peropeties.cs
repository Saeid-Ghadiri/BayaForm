...
{
    public class Form_774_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_SalaryPaymentItems? _Entity { get; set; } = new Entity.HR_CVR_SalaryPaymentItems();
...
public Input<string?> Ref_ShomaranCode;
public Dropdown Ref_HR_SalaryPaymentItemsTypeId;
