...
{
    public class Form_568_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.PPCAtlasBobbin_Customer? _Entity { get; set; } = new Entity.PPCAtlasBobbin_Customer();
...
public Input<string?> Ref_CustomerCode;
public Input<string?> Ref_CustomerName;
public Input<string?> Ref_CustomerEnName;
public Input<string?> Ref_FactoryAddress;
public Input<string?> Ref_OfficeAddress;
public Input<string?> Ref_DeliveryAddress;
public Input<string?> Ref_FactoryTel;
public Input<string?> Ref_OfficeTel;
public Input<string?> Ref_ContactPerson;
public RadioBoolean Ref_IsForiegn;
