...
{
    public class Form_889_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMPETCO_TitleInspectionMethod_Supplier? _Entity { get; set; } = new Entity.SCMPETCO_TitleInspectionMethod_Supplier();
