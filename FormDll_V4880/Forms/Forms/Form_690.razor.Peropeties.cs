...
{
    public class Form_690Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_Base_InsuranceTypes> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_Base_InsuranceTypes())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_690_CU RefForm { get; set; }
    public Form_690_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_Base_InsuranceTypes;
