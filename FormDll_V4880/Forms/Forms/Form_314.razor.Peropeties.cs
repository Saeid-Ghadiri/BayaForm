...
{
    public class Form_314Peropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.test_Mosaedeh? _Entity { get; set; } = new Entity.test_Mosaedeh();
...
public Input<string?> Ref_DateTimeReq;
public Input<int?> Ref_Price;
public Input<string?> Ref_UserName;
public Input<string?> Ref_test;
