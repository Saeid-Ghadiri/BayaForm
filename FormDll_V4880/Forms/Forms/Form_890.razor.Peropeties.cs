...
{
    public class Form_890Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPETCO_SCMPETCO_TitleTransportationMethod_Supplier> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPETCO_SCMPETCO_TitleTransportationMethod_Supplier())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_890_CU RefForm { get; set; }
    public Form_890_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPETCO_SCMPETCO_TitleTransportationMethod_Supplier;
