...
{
    public class Form_677_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_EMP_AcademicDocuments? _Entity { get; set; } = new Entity.HR_EMP_AcademicDocuments();
...
public Dropdown Ref_HR_Base_SpecializationId;
public Dropdown Ref_HR_Base_UniversityId;
public Input<string?> Ref_StartDate;
public Input<string?> Ref_EndDate;
public Input<decimal?> Ref_Score;
public Dropdown Ref_HR_Base_AcademicDegreesId;
public Input<string?> Ref_DocumentSerialNo;
public Input<bool?> Ref_HasInquiring;
public Input<string?> Ref_InquiringDate;
