...
{
    public class Form_886_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMPETCO_ScoringMethod_Supplier? _Entity { get; set; } = new Entity.SCMPETCO_ScoringMethod_Supplier();
...
public Input<byte?> Ref_ScoringNo;
