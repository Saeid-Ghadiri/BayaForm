...
{
    public class Form_974_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.Shomaran_DepoIn? _Entity { get; set; } = new Entity.Shomaran_DepoIn();
...
public Dropdown Ref_Shomaran_DepoInDetail_PartCode;
