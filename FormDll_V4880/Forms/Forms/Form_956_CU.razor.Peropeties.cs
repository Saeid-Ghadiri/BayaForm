...
{
    public class Form_956_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SH_PolFilm_InsertParts? _Entity { get; set; } = new Entity.SH_PolFilm_InsertParts();
...
public Dropdown Ref_Shomaran_ProductTypeId;
public Dropdown Ref_Units;
public Dropdown Ref_Units2;
public Dropdown Ref_Shomaran_FiscalYearId;
