...
{
    public class Form_908Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.BaseInfo_ORG_Sites> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.BaseInfo_ORG_Sites())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_908_CU RefForm { get; set; }
    public Form_908_Filter RefListFilter  { get; set; }

public DxGrid? Grid_BaseInfo_ORG_Sites;
