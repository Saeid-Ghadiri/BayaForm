...
{
    public class Form_719_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMPLATE_NQGT_WarehouseByLogistics? _Entity { get; set; } = new Entity.SCMPLATE_NQGT_WarehouseByLogistics();
