...
{
    public class Form_737Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_RMS_BaseInterviewScores> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_RMS_BaseInterviewScores())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_737_CU RefForm { get; set; }
    public Form_737_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_RMS_BaseInterviewScores;
