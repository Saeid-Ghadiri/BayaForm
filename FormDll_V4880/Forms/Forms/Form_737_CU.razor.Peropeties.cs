...
{
    public class Form_737_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_RMS_BaseInterviewScores? _Entity { get; set; } = new Entity.HR_RMS_BaseInterviewScores();
...
public Dropdown Ref_HR_RMS_InterviewScoresId;
public Input<string?> Ref_ReviewTopics;
public Input<bool?> Ref_Status;
