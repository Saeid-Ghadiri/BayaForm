...
{
    public class Form_777Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_CVR_RightGuardianship> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_CVR_RightGuardianship())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_777_CU RefForm { get; set; }
    public Form_777_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_CVR_RightGuardianship;
