...
{
    public class Form_1008_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.IDMS_Customer? _Entity { get; set; } = new Entity.IDMS_Customer();
...
public Input<double?> Ref_CustomerCode;
public Input<string?> Ref_CustomerTitle;
