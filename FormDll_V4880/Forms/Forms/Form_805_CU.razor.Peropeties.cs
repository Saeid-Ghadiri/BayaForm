...
{
    public class Form_805_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_StatusHiringtQuestionnaireAnnouncemen? _Entity { get; set; } = new Entity.HR_StatusHiringtQuestionnaireAnnouncemen();
