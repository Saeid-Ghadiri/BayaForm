...
{
    public class Form_1011_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.test_testsaeid? _Entity { get; set; } = new Entity.test_testsaeid();
...
public Input<string?> Ref_field1;
public Input<string?> Ref_field2;
