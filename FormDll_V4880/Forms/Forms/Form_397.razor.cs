...
{
    public class Form_397Base : Form_397Peropeties
    {
        ...
        // settings.Position=Blazored.Toast.Configuration.ToastPosition.TopRight;}))"
    ...
    public override async Task<Baya.Models.Utility.Result> Submit()
    {
        ...
        var ResualtBeforSubmit = await BeforSubmit();
