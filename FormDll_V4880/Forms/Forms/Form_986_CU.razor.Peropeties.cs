...
{
    public class Form_986_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.test_Counter3? _Entity { get; set; } = new Entity.test_Counter3();
...
public Input<long> Ref_CounterField;
public Input<long?> Ref_test;
public SingleUploader Ref_SUpload;
