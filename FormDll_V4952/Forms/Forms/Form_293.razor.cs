...
{
    public class Form_293Base : Form_293Peropeties
    {
    ...
    public override async Task<bool> FormValidator()
    {
        ...
        {
            // توضیحات تایید استعلام مدیر فنی
            if(Item.ConfirmationOfTheInquiryTechnicalManager == null)
            {
				IsValid = false;
				toastService.ShowError("لطفا گزینه توضیحات تایید استعلام مدیر فنی را تکمیل نمایید.",
				settings => {
					settings.Timeout = 4;
...
return new Result() { Status = HttpStatusCode.OK };
    ...
    public async Task <bool> SCM_ProductRequestDetails_editmodelsaving(object e   )
        ...
        // توضیحات تایید استعلام مدیر فنی
        if(EntityDetail.ConfirmationOfTheInquiryTechnicalManager == null)
        {
			IsCancelled = true;
			toastService.ShowError("لطفا گزینه توضیحات تایید استعلام مدیر فنی را تکمیل نمایید.",
			settings => {
