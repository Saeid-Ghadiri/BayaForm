...
{
    public class Form_549Base : Form_549Peropeties
    {
    ...
    public override async Task<bool> FormValidator()
    {
        ...
        foreach (var Item in List)
        {
            ...
            if (Item.SCM_ProcurementId == null)
			{
				...
				toastService.ShowError("لطفا گزینه انتخاب کارشناس تدارکات را تکمیل نمایید.",
				settings => {
					settings.Timeout = 4;
...
return new Result() { Status = HttpStatusCode.OK };
    ...
    #region FunctionEvents
		...
		public async Task<bool> SCM_OS_Details_editmodelsaving(object e   )
        {
            ...
            // انتخاب کارشناس تدارکات
            if (MainModel.SCM_ProcurementId == null)
	        {
	        	IsCancelled = true;            
	        	toastService.ShowError("لطفا گزینه انتخاب کارشناس تدارکات را تکمیل نمایید.",
	        	settings => {
		...
		public async Task  SCM_ProcurementId_onitemselected(Entity.SCM_Procurement Selected ,Entity.SCM_OS_Details Item  )
        {
