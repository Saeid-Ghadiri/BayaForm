...
{
    public class Form_297Base : Form_297Peropeties
    {
        ...
        public override async Task<bool> FormValidator()
        {
            ...
            foreach (var Item in List)
            {
                ...
                // تعداد مراحل واگذاری کالا به انبار                
                    if (Item.SCM_NumTransfersGoodsWarehouseId == null)
                    {
                        IsValid = false;
                        toastService.ShowError("لطفا گزینه تعداد مراحل واگذاری کالا به انبار را تکمیل نمایید.",
                        settings =>
                        {
                            settings.Timeout = 4;
                            settings.ShowProgressBar = true;
                ...
                // 82329c07-2aa7-ef11-8354-005056a02a64     یک مرحله    Code=1001
                // cc59710f-2aa7-ef11-8354-005056a02a64     دو مرحله    Code=1002
                // 13a46c17-2aa7-ef11-8354-005056a02a64     سه مرحله    Code=1003
        ...
        public async Task<bool> SCM_ProductRequestDetails_editmodelsaving(object e)
        {
            ...
            var NDL2IsVisible = Ref_SCM_ProductRequestDetails_TheNumberDeliveredByLogistics2;
            var NDL3IsVisible = Ref_SCM_ProductRequestDetails_TheNumberDeliveredByLogistics3;
            var NTGW = Ref_SCM_ProductRequestDetails_SCM_NumTransfersGoodsWarehouseId;
            //Console.WriteLine("Item.SCM_NumTransfersGoodsWarehouseId.ToString()");
            //Console.WriteLine(Item.SCM_NumTransfersGoodsWarehouseId.ToString());
            //Console.WriteLine(Item.TheNumberDeliveredByLogistics.ToString());
            // نمایش تعداد یا مقدار واگذاری کالا به انبار توسط تدارکات 
            if (NTGW.Value.ToString() == "82329c07-2aa7-ef11-8354-005056a02a64")
            {
                if (NDL1IsVisible.Value == null)
                {
                    IsCancelled = true;
                    toastService.ShowError("لطفا گزینه تعداد یا مقدار واگذاری کالا به انبار توسط تدارکات 1 را تکمیل نمایید.",
                    settings =>
            ...
            if (NTGW.Value.ToString() == "cc59710f-2aa7-ef11-8354-005056a02a64")
            {
                if (NDL1IsVisible.Value == null || NDL2IsVisible.Value == null)
                {
                    IsCancelled = true;
                    toastService.ShowError("لطفا گزینه تعداد یا مقدار واگذاری کالا به انبار توسط تدارکات 1 و 2 را تکمیل نمایید.",
                    settings =>
            ...
            if (NTGW.Value.ToString() == "13a46c17-2aa7-ef11-8354-005056a02a64")
            {
                if (NDL1IsVisible.Value == null || NDL2IsVisible.Value == null || NDL3IsVisible.Value == null)
                {
                    IsCancelled = true;
                    toastService.ShowError("لطفا گزینه تعداد یا مقدار واگذاری کالا به انبار توسط تدارکات 1 و 2 و 3 را تکمیل نمایید.",
                    settings =>
