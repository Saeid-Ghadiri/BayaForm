...
{
    public class Form_268Base : Form_268Peropeties
    {
...
return new Result() { Status = HttpStatusCode.OK };
    ...
    #region FunctionEvents
		...
		public async Task UserName_onclick(MouseEventArgs Selected   )
        {
await Swal.FireAsync("Any fool can use a computer");
		...
		public async Task  OrderDate_oncut(ClipboardEventArgs Selected   )
        {
