...
{
    public class Form_285Peropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.FileUploads_MainFileUploads? _Entity { get; set; } = new Entity.FileUploads_MainFileUploads();
...
public DxGrid? Grid_FileUploads_FileUploads;

public Input<Guid> Ref_FileUploads_FileUploads_Id;
public Input<Guid?> Ref_FileUploads_FileUploads_RequestID;
public Input<Guid?> Ref_FileUploads_FileUploads_CreateUser;
public Input<Guid?> Ref_FileUploads_FileUploads_UpdateUser;
public Input<DateTime?> Ref_FileUploads_FileUploads_CreateDate;
public Input<DateTime?> Ref_FileUploads_FileUploads_UpdateDate;
public Input<bool?> Ref_FileUploads_FileUploads_IsDelete;
public Input<string?> Ref_FileUploads_FileUploads_FileTitle;
public FileUploadPage.Uploader<Entity.FileUploads_FileUploads_FileUpload> Ref_FileUploads_FileUploads_FileUploads_FileUploads_FileUpload;
