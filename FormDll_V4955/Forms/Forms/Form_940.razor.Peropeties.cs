...
{
    public class Form_940Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_JobInterviewContractType> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_JobInterviewContractType())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_940_CU RefForm { get; set; }
    public Form_940_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_JobInterviewContractType;
