...
{
    public class Form_808Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_ReasonRequestRecruitment> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_ReasonRequestRecruitment())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_808_CU RefForm { get; set; }
    public Form_808_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_ReasonRequestRecruitment;
