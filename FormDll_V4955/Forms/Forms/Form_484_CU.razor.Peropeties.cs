...
{
    public class Form_484_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.PPCAtlasBobbin_RawMaterialGroup? _Entity { get; set; } = new Entity.PPCAtlasBobbin_RawMaterialGroup();
...
public Input<Guid?> Ref_PPCAtlasBobbin_RawMaterial_RequestID;
public Input<Guid?> Ref_PPCAtlasBobbin_RawMaterial_CreateUser;
public Input<Guid?> Ref_PPCAtlasBobbin_RawMaterial_UpdateUser;
public Input<DateTime?> Ref_PPCAtlasBobbin_RawMaterial_CreateDate;
public Input<DateTime?> Ref_PPCAtlasBobbin_RawMaterial_UpdateDate;
public Input<bool?> Ref_PPCAtlasBobbin_RawMaterial_IsDelete;
public Input<string> Ref_PPCAtlasBobbin_RawMaterial_RawMaterialCode;
...
public Input<int?> Ref_PPCAtlasBobbin_RawMaterial_Width;
