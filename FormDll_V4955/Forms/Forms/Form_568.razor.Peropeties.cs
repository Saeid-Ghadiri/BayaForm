...
{
    public class Form_568Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.PPCAtlasBobbin_Customer> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.PPCAtlasBobbin_Customer())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_568_CU RefForm { get; set; }
    public Form_568_Filter RefListFilter  { get; set; }

public DxGrid? Grid_PPCAtlasBobbin_Customer;
