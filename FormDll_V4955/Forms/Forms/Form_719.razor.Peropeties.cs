...
{
    public class Form_719Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPLATE_NQGT_WarehouseByLogistics> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPLATE_NQGT_WarehouseByLogistics())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_719_CU RefForm { get; set; }
    public Form_719_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPLATE_NQGT_WarehouseByLogistics;
