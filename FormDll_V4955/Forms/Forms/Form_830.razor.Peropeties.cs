...
{
    public class Form_830Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_SalaryPaymentItemsType> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_SalaryPaymentItemsType())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_830_CU RefForm { get; set; }
    public Form_830_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_SalaryPaymentItemsType;
