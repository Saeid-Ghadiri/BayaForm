...
{
    public class Form_881Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPETCO_TitlePreAssessment_Supplier> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPETCO_TitlePreAssessment_Supplier())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_881_CU RefForm { get; set; }
    public Form_881_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPETCO_TitlePreAssessment_Supplier;
