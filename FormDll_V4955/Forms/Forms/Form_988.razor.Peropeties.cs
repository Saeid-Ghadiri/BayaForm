...
{
    public class Form_988Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_EmployeeContractType> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_EmployeeContractType())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_988_CU RefForm { get; set; }
    public Form_988_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_EmployeeContractType;
