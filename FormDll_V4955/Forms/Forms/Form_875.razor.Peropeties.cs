...
{
    public class Form_875Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPETCO_LogisticsDeliveryType> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPETCO_LogisticsDeliveryType())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_875_CU RefForm { get; set; }
    public Form_875_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPETCO_LogisticsDeliveryType;
