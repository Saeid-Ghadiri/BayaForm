...
{
    public class Form_597Peropeties : FormBase
    {
...
public Input<string?> Ref_SCMPLATE_ProductRequestDetails_ApproverDescription;
public Input<double?> Ref_SCMPLATE_ProductRequestDetails_PurchasePrice;
public RadioBoolean Ref_SCMPLATE_ProductRequestDetails_SupplyGoodsIsEnable;
public RadioBoolean Ref_SCMPLATE_ProductRequestDetails_ITILCodeIsEnable;
public Dropdown Ref_SCMPLATE_ProductRequestDetails_ResultingFromITIL;
public Input<string?> Ref_SCMPLATE_ProductRequestDetails_RequesterUserITIL;
public Input<string?> Ref_SCMPLATE_ProductRequestDetails_CreatedAtITIL;
public Dropdown Ref_SCMPLATE_ProductRequestDetails_ITILDetails;
...
public Input<Guid?> Ref_SCMPLATE_ProductRequestDetails_SH_GRCODE_GUID;
public Input<string?> Ref_SCMPLATE_ProductRequestDetails_SH_GroupName;
public Input<string?> Ref_SCMPLATE_ProductRequestDetails_SH_SubGroupName;
public Input<int?> Ref_SCMPLATE_ProductRequestDetails_SH_YEAR;
...
public Input<string?> Ref_SCMPLATE_ProductRequestDetails_RequestIdITIL;
