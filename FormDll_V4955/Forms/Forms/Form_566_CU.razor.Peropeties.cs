...
{
    public class Form_566_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.PPCAtlasBobbin_Producer? _Entity { get; set; } = new Entity.PPCAtlasBobbin_Producer();
...
public Input<string?> Ref_ProducerName;
