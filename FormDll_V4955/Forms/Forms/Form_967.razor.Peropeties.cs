...
{
    public class Form_967Peropeties : FormBase
    {
...
public Dropdown Ref_AnbarMavad_Transfer_TempNoNum_NotMapped;
public Input<string?> Ref_FACTNO_GUID;
public Input<string?> Ref_FACTNO_Transfer;
public Dropdown Ref_T_TransferDtl;
