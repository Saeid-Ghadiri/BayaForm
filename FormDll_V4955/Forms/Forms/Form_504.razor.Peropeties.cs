...
{
    public class Form_504Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPETCO_AreaOperation> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPETCO_AreaOperation())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_504_CU RefForm { get; set; }
    public Form_504_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPETCO_AreaOperation;
