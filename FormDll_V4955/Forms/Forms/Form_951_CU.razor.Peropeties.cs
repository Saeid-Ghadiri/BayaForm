...
{
    public class Form_951_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.Shomaran_PSOURCE? _Entity { get; set; } = new Entity.Shomaran_PSOURCE();
...
public Input<Guid?> Ref_Shomaran_Anbord_PSOURCE2;
