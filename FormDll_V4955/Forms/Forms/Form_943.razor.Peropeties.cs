...
{
    public class Form_943Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_InterviewResumeSite> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_InterviewResumeSite())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_943_CU RefForm { get; set; }
    public Form_943_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_InterviewResumeSite;
