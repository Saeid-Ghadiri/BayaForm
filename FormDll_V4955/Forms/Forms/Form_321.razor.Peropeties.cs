...
{
    public class Form_321Peropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_Leave? _Entity { get; set; } = new Entity.HR_Leave();
...
public RadioBoolean Ref_LeaveType;
public Dropdown Ref_HR_PermissionGroupId;
public Input<string> Ref_StartDate;
public Input<string> Ref_EndDate;
public Time Ref_StartTime;
public Time Ref_EndTime;
...
public Input<Guid> Ref_EmployeeId;
public Input<int> Ref_UserStarterCompanyID;
public Input<DateTime?> Ref_StartDateEN;
public Input<DateTime?> Ref_EndDateEN;
public Input<double?> Ref_Duration;
