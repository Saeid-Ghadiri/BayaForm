...
{
    public class Form_792_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_RMS_TrainingCourses? _Entity { get; set; } = new Entity.HR_RMS_TrainingCourses();
...
public Input<string?> Ref_TitleCourse;
public Input<string?> Ref_EducationalInstitution;
public Input<string?> Ref_CourseYear;
public Input<byte?> Ref_CourseDuration;
public RadioBoolean Ref_HasCertificate;
