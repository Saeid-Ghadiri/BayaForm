...
{
    public class Form_905Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPETCO_ReceivedInventory> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPETCO_ReceivedInventory())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_905_CU RefForm { get; set; }
    public Form_905_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPETCO_ReceivedInventory;
