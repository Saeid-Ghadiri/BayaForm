...
{
    public class Form_616_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_EMP_Documents? _Entity { get; set; } = new Entity.HR_EMP_Documents();
...
public Dropdown Ref_HR_Base_DocumentTypesId;
public Input<string?> Ref_Title;
public Input<string?> Ref_Description;
public Input<bool?> Ref_IsActive;
public FileUploadPage.Uploader<Entity.HR_EMP_Documents_AttachmentFile> Ref_HR_EMP_Documents_AttachmentFile;
