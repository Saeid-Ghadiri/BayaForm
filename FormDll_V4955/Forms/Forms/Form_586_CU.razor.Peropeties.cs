...
{
    public class Form_586_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.Global_Vehicle? _Entity { get; set; } = new Entity.Global_Vehicle();
...
public DxGrid? Grid_PPCAtlasBobbin_EnteringWarehouse;

public Input<Guid> Ref_PPCAtlasBobbin_EnteringWarehouse_Id;
public Input<Guid?> Ref_PPCAtlasBobbin_EnteringWarehouse_RequestID;
public Input<Guid?> Ref_PPCAtlasBobbin_EnteringWarehouse_CreateUser;
public Input<Guid?> Ref_PPCAtlasBobbin_EnteringWarehouse_UpdateUser;
public Input<DateTime?> Ref_PPCAtlasBobbin_EnteringWarehouse_CreateDate;
public Input<DateTime?> Ref_PPCAtlasBobbin_EnteringWarehouse_UpdateDate;
public Input<bool?> Ref_PPCAtlasBobbin_EnteringWarehouse_IsDelete;
