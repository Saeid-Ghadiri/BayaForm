...
{
    public class Form_362Peropeties : FormBase
    {
...
public Input<string?> Ref_SCMNFP_InquiryPriceProduct_DescriptionInquiryFactoryManager;
public Input<string?> Ref_SCMNFP_InquiryPriceProduct_DescriptionInquiryCEO;
