...
{
    public class Form_509_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.Global_UploadFiles? _Entity { get; set; } = new Entity.Global_UploadFiles();
...
public FileUploadPage.Uploader<Entity.Global_UploadFiles_File> Ref_Global_UploadFiles_File;
