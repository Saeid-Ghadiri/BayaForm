...
{
    public class Form_906_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.Shomaran_ProductDelivery? _Entity { get; set; } = new Entity.Shomaran_ProductDelivery();
...
public Input<int?> Ref_FORMYEAR;
public Dropdown Ref_ORDERYEAR;
public Dropdown Ref_INVCODE;
public Input<string?> Ref_TEMPNO;
public Input<int?> Ref_H_KIND;
...
public Input<string?> Ref_CENTCODE2;
...
public Dropdown Ref_Shomaran_ProductDeliveryDetail_PARTCODE;
public Input<string?> Ref_Shomaran_ProductDeliveryDetail_RADYABI;
