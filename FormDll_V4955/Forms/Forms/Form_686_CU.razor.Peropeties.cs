...
{
    public class Form_686_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_Base_TransportServiceStationsAssign? _Entity { get; set; } = new Entity.HR_Base_TransportServiceStationsAssign();
