...
{
    public class Form_783_CUPeropeties : FormBase
    {
...
public Dropdown Ref_AdministrativeApproverUserId;
public Input<byte?> Ref_AdministrativeContractPeriodMonth;
public Input<string?> Ref_AdministrativeApprovalTime;
public Input<string?> Ref_AdministrativeDescription;
public Dropdown Ref_ConfirmerContractRelevantMattersUserId;
public Input<byte?> Ref_DurationContractRelevantMatters;
public Input<byte?> Ref_RegisterTimeContractRelevantMatters;
public Input<string?> Ref_DescriptionContractRelevantMatters;
public Dropdown Ref_ConfirmerFactoryManagerContractMonthUserId;
public Input<byte?> Ref_FactoryManagerContractMonth;
public Input<string?> Ref_RegisterTimeFactoryManagerContractMonth;
public Input<string?> Ref_DescriptionFactoryManagerContractMonth;
public Input<byte?> Ref_ContractPeriodFinalizer;
public Input<string?> Ref_RegisterTimeContractPeriodFinalizer;
public Input<string?> Ref_DescriptionContractPeriodFinalizer;
public Dropdown Ref_RejectionUserId;
public Input<string?> Ref_RejectionTime;
public Input<string?> Ref_ReasonRejection;
