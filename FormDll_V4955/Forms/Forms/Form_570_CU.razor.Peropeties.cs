...
{
    public class Form_570_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.PPCAtlasBobbin_EnteringWarehouse? _Entity { get; set; } = new Entity.PPCAtlasBobbin_EnteringWarehouse();
...
public Input<int?> Ref_EnteringWarehouseNo;
public Input<int?> Ref_BarNamehNo;
public Input<string?> Ref_DateBarnameh;
public Dropdown Ref_Global_VehicleId;
...
public Input<Guid?> Ref_PPCAtlasBobbin_EnteringWarehouseDetail_RequestID;
public Input<Guid?> Ref_PPCAtlasBobbin_EnteringWarehouseDetail_CreateUser;
public Input<Guid?> Ref_PPCAtlasBobbin_EnteringWarehouseDetail_UpdateUser;
public Input<DateTime?> Ref_PPCAtlasBobbin_EnteringWarehouseDetail_CreateDate;
public Input<DateTime?> Ref_PPCAtlasBobbin_EnteringWarehouseDetail_UpdateDate;
public Input<bool?> Ref_PPCAtlasBobbin_EnteringWarehouseDetail_IsDelete;
public Dropdown Ref_PPCAtlasBobbin_EnteringWarehouseDetail_Global_Global_PackagingId;
public Dropdown Ref_PPCAtlasBobbin_EnteringWarehouseDetail_PPCAtlasBobbin_RawMaterialId;
public Dropdown Ref_PPCAtlasBobbin_EnteringWarehouseDetail_Global_UnitId;
public Dropdown Ref_PPCAtlasBobbin_EnteringWarehouseDetail_PPCAtlasBobbin_ProducerId;
