...
{
    public class Form_790_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_RMS_RecruitmentRequests? _Entity { get; set; } = new Entity.HR_RMS_RecruitmentRequests();
...
public Dropdown Ref_HR_ReasonRequestRecruitmentId;
public Input<string?> Ref_RequiredDocuments;
public Input<byte?> Ref_FromAge;
public Input<string?> Ref_RegisterTimeRequestUserId;
public Dropdown Ref_HR_ORG_SectionsId;
public Dropdown Ref_HR_Base_FieldOfStudyId;
public Input<byte?> Ref_ToAge;
public Input<string?> Ref_DescriptionRequest;
public Dropdown Ref_HR_ORG_PostsId;
public Input<string?> Ref_Skills;
public Input<byte?> Ref_MinimumRequirement;
public Dropdown Ref_HR_ApplicationStatusRecruitmentId;
public Dropdown Ref_HR_Base_GenderId;
public Input<byte?> Ref_RequiredNumber;
public Dropdown Ref_UnitManagerUserId;
public Input<string?> Ref_RegisterTimeUserManger;
public Input<string?> Ref_DescriptionUnitManager;
public Dropdown Ref_FactoryManagerUserId;
public Input<string?> Ref_DescriptionFactoryManager;
public Input<string?> Ref_RegisterTimeFactoryManager;
public Dropdown Ref_HumanResourcesManagerUserId;
public Input<string?> Ref_DescriptionSectionHumanResourcesManager;
public Input<string?> Ref_RegisterTimeHumanResourcesManager;
public Dropdown Ref_FinalApproverUserId;
public Input<string?> Ref_DescriptionFinalApprover;
public Input<string?> Ref_RegisterTimeFinalApprover;
