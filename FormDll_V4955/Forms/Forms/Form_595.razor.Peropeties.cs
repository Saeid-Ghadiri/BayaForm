...
{
    public class Form_595Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.PPCAtlasBobbin_StationType> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.PPCAtlasBobbin_StationType())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_595_CU RefForm { get; set; }
    public Form_595_Filter RefListFilter  { get; set; }

public DxGrid? Grid_PPCAtlasBobbin_StationType;
