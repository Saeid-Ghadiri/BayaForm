...
{
    public class Form_849Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCM_MaterialWarehouse_PlaceofUse> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCM_MaterialWarehouse_PlaceofUse())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_849_CU RefForm { get; set; }
    public Form_849_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCM_MaterialWarehouse_PlaceofUse;
