...
{
    public class Form_964Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SH_PolFilm_FACTBUY> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SH_PolFilm_FACTBUY())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_964_CU RefForm { get; set; }
    public Form_964_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SH_PolFilm_FACTBUY;
