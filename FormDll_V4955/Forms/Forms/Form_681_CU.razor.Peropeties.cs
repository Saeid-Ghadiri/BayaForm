...
{
    public class Form_681_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_ORG_PositionClassification? _Entity { get; set; } = new Entity.HR_ORG_PositionClassification();
