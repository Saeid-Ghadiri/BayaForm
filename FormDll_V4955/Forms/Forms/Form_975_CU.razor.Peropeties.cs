...
{
    public class Form_975_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMPETCO_SupplierEvaluationTitle? _Entity { get; set; } = new Entity.SCMPETCO_SupplierEvaluationTitle();
...
public Input<long> Ref_Code;
public Input<string?> Ref_Title;
public Input<int?> Ref_Status;
