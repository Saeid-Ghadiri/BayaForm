...
{
    public class Form_990_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_AnnualBaseWageIncreaseRates? _Entity { get; set; } = new Entity.HR_CVR_AnnualBaseWageIncreaseRates();
...
public Input<decimal?> Ref_IncreasePercentMinistryLabor;
public Input<decimal?> Ref_IncreasePercentGroup;
