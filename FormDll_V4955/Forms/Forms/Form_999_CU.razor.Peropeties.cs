...
{
    public class Form_999_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_CVR_OrderExtraBenefits? _Entity { get; set; } = new Entity.HR_CVR_OrderExtraBenefits();
...
public Input<decimal?> Ref_DailyAdjustmentDiff;
