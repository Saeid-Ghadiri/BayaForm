...
{
    public class Form_552Peropeties : FormBase
    {
...
public Input<int?> Ref_SCM_OS_Details_InvoiceNum;
...
public FileUploadPage.Uploader<Entity.SCM_OS_Details_InvoiceFile> Ref_SCM_OS_Details_SCM_OS_Details_InvoiceFile;
