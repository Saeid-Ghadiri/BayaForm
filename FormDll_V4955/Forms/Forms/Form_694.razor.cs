...
{
    public class Form_694Base : Form_694Peropeties
    {
    ...
    public override async Task<bool> FormValidator()
    {
       bool IsValid = true;
        ...
        var List = _Entity.SCM_ProductRequestDetails.Where(p=>p.IsDelete == false).ToList();
            ...
            // دکمه ثبت و ادامه           
            if (BtnWorkFlowId == "SequenceFlow_0vgw83f"||BtnWorkFlowId == "SequenceFlow_0w24qt3")
            {
            ...
            // لغو کلی درخواست
            if (BtnWorkFlowId == "SequenceFlow_1wedc61"||BtnWorkFlowId == "SequenceFlow_0jwar5t")
            {
