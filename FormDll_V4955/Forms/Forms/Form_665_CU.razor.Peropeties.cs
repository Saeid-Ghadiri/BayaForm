...
{
    public class Form_665_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_EMP_EmployeeDetails? _Entity { get; set; } = new Entity.HR_EMP_EmployeeDetails();
...
public Input<string?> Ref_OrgTel1;
public Input<string?> Ref_OrgTel2;
public Input<string?> Ref_OrgTel3;
public Input<string?> Ref_OrgTel4;
