...
{
    public class Form_949Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.Shomaran_OpneClose> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.Shomaran_OpneClose())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_949_CU RefForm { get; set; }
    public Form_949_Filter RefListFilter  { get; set; }

public DxGrid? Grid_Shomaran_OpneClose;
