...
{
    public class Form_786Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_RMS_HiringtQuestionnaireAnnouncemen> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_RMS_HiringtQuestionnaireAnnouncemen())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_786_CU RefForm { get; set; }
    public Form_786_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_RMS_HiringtQuestionnaireAnnouncemen;
