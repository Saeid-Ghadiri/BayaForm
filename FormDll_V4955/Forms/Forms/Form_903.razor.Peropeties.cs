...
{
    public class Form_903Peropeties : FormBase
    {
...
public Input<string?> Ref_ProcurementSupervisorDesc;
public Input<string?> Ref_QCManagerDec;
public Input<string?> Ref_SystemsMethodsDesc;
public Input<string?> Ref_HSEDesc;
public Input<string?> Ref_FactoryManagerDesc;
public Input<string?> Ref_CEODesc;
