...
{
    public class Form_386Peropeties : FormBase
    {
...
public RadioBoolean Ref_SCM_OS_Details_OutWarehouseIsEnable;
public Input<string?> Ref_SCM_OS_Details_DepartureDate;
