...
{
    public class Form_508_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.Global_UploadFiles_File? _Entity { get; set; } = new Entity.Global_UploadFiles_File();
...
public Input<string?> Ref_storage;
public Input<Guid?> Ref_Global_UploadFilesId;
public Input<string?> Ref_url;
public Input<string?> Ref_name;
public Input<string?> Ref_size;
public Input<string?> Ref_type;
public Input<string?> Ref_originalName;
public Input<string?> Ref_hash;
