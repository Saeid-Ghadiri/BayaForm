...
{
    public class Form_545Base : Form_545Peropeties
    {
    ...
    public override async Task<bool> FormValidator()
    {
        ...
        foreach (var Item in List)
        {
            ...
            // if( _Entity.SCM_ResultingFromId.HasValue && _Entity.SCM_ResultingFromId.ToString() == "6c3840b6-6a26-ef11-8351-005056a02a64")
            // {             
            //     if (Item.DesignMakeNum == null)
            //     {
            //         IsValid = false;
            //         toastService.ShowError("لطفا گزینه شماره طراحی و ساخت را تکمیل نمایید.",
            //         settings => {
            //             settings.Timeout = 4;
            //             settings.ShowProgressBar = true;
            //             settings.PauseProgressOnHover = true;
	...
	public async Task<bool> SCM_OS_Details_editmodelsaving(object e   )
    {
        ...
        if (ModelDetail.SCM_PriorityId == null)
		{
            ...
            {
                if (ModelDetail.SCM_OS_Details_UploadFile == null)
			    {
			    	IsCancelled = true;
            ...
            // SCM_AreaOperationId
            if (ModelDetail.SCM_AreaOperationId == null)
			{
				IsCancelled = true;
    ...
    {
        // // فیلد منتج از درخواست برون سپاری - فیلد طراحی و ساخت 
        // // Id = 6c3840b6-6a26-ef11-8351-005056a02a64

        // if( _Entity.SCM_ResultingFromId.HasValue && _Entity.SCM_ResultingFromId.ToString() == "6c3840b6-6a26-ef11-8351-005056a02a64")
        // {             
        //     //await ResultingFrom_TarahiSakht(true);
        //     Ref_SCM_OS_Details_DesignMakeNum.SetVisible(true);
        // }
        // else
        // {            
        //     //await ResultingFrom_TarahiSakht(false);
