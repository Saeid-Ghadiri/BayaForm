...
{
    public class Form_681Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_ORG_PositionClassification> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_ORG_PositionClassification())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_681_CU RefForm { get; set; }
    public Form_681_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_ORG_PositionClassification;
