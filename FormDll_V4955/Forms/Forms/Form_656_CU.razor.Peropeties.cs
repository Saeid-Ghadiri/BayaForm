...
{
    public class Form_656_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_ORG_Sections? _Entity { get; set; } = new Entity.HR_ORG_Sections();
...
public Dropdown Ref_HR_ORG_SectionTypesId;
