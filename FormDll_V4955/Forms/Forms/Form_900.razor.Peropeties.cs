...
{
    public class Form_900Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPETCO_QCInspectionAreas> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPETCO_QCInspectionAreas())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_900_CU RefForm { get; set; }
    public Form_900_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPETCO_QCInspectionAreas;
