...
{
    public class Form_519Base : Form_519Peropeties
    {
       // Toast  
		[Inject]
    ...
    public override async Task<bool> FormValidator()
    {
        bool IsValid = true;
            ...
            // دکمه ثبت و ادامه           
            if (BtnWorkFlowId == "SequenceFlow_0e4x3s1")
            {
            ...
            // لغو کلی درخواست
            if (BtnWorkFlowId == "SequenceFlow_1kb7lx4")
            {
    ...
    public async Task<bool> CheckFieldValidation(Entity.SCM_ProductRequestDetails Item)
 		{
            ...
            // استعلام تایید شده - ConfirmationOfTheInquiryFactoryManager
