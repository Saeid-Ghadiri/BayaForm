...
{
    public class Form_863Peropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMICT_Product? _Entity { get; set; } = new Entity.SCMICT_Product();
...
public Input<Guid?> Ref_SCMICT_Order1_RequestID;
public Input<Guid?> Ref_SCMICT_Order1_CreateUser;
public Input<Guid?> Ref_SCMICT_Order1_UpdateUser;
public Input<DateTime?> Ref_SCMICT_Order1_CreateDate;
