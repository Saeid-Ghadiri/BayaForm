...
{
	public class Form_559Base : Form_559Peropeties
	{
        ...
        public async Task HavaleMasrafIsNull()
        {
            Ref_SCM_ProductRequestDetails_T_Search_NotMapped = null;
            Ref_SCM_ProductRequestDetails_T_CENTCODE = null;
            Ref_SCM_ProductRequestDetails_T_CENTCODE_GUID = null;
            Ref_SCM_ProductRequestDetails_T_PAYCENTName = null;
            Ref_SCM_ProductRequestDetails_T_CREATOR = null;
            Ref_SCM_ProductRequestDetails_T_FACTDATE = null;
            Ref_SCM_ProductRequestDetails_T_FACTNO = null;
            Ref_SCM_ProductRequestDetails_T_FACTNO_GUID = null;
            Ref_SCM_ProductRequestDetails_T_TEMPNO = null;
            Ref_SCM_ProductRequestDetails_T_TempNoNum = null;
            Ref_SCM_ProductRequestDetails_T_YEAR = null;
            Ref_SCM_ProductRequestDetails_SH_Tahvil_DTL = null;
        }
		...
		public async Task  SCM_ProductRequestDetails_afterrendermodal(Entity.SCM_ProductRequestDetails Item   )
        {
            ...
            else
            {
                ...
                if (Item.Global_SCMRequestTypeId.ToString() == "73f6c459-d99c-ef11-8354-005056a02a64")
                {
                    ...
                    await ResidAnbarIsVisible(true);
                }
            }
		...
		public async Task  Global_ShomaranInfoId_onitemselected(Entity.Global_ShomaranInfo Selected ,Entity.SCM_ProductRequestDetails Item  )
        {
			// انتخاب نوع ثبت عطف در شماران      
            ...
            else
            {
                ...
                {
                    //Console.WriteLine("#Log 3.1-dropdown" + Ref_SCM_ProductRequestDetails_FB_Search_NotMapped.Value);
