...
{
    public class Form_806Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_ApplicationStatusRecruitment> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_ApplicationStatusRecruitment())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_806_CU RefForm { get; set; }
    public Form_806_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_ApplicationStatusRecruitment;
