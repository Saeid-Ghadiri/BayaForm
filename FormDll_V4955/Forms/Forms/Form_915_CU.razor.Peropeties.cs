...
{
    public class Form_915_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.BaseInfo_Provinces? _Entity { get; set; } = new Entity.BaseInfo_Provinces();
...
public Dropdown Ref_BaseInfo_CountriesId;
public Input<string?> Ref_Title;
public Input<string?> Ref_Tel_Code;
