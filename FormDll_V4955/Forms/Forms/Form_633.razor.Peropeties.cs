...
{
    public class Form_633Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_Base_FieldOfStudy> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_Base_FieldOfStudy())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_633_CU RefForm { get; set; }
    public Form_633_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_Base_FieldOfStudy;
