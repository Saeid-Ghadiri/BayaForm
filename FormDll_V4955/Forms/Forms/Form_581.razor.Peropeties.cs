...
{
    public class Form_581Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.Global_Global_Packaging> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.Global_Global_Packaging())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_581_CU RefForm { get; set; }
    public Form_581_Filter RefListFilter  { get; set; }

public DxGrid? Grid_Global_Global_Packaging;
