...
{
    public class Form_553Base : Form_553Peropeties
    {
        ...
        // DateTimeDeliveryWarehouse - تاریخ و ساعت تحویل از انبار        
        public async Task DT_Anbardar_Requester()
        {
            ...
            for (int i = 0; i < List.Count; i++)
            {
                ...
                item.DateTimeDeliveryWarehouse = PC.GetYear(DateNow) + "/" + PC.GetMonth(DateNow).ToString("0#") + "/" + PC.GetDayOfMonth(DateNow).ToString("0#");
        ...
        {
            // تاریخ تحویل کالا به درخواست دهنده
            await DT_Anbardar_Requester();
