...
{
    public class Form_901Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPETCO_QCStatusTypes> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPETCO_QCStatusTypes())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_901_CU RefForm { get; set; }
    public Form_901_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPETCO_QCStatusTypes;
