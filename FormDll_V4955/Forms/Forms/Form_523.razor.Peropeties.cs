...
{
    public class Form_523Peropeties : FormBase
    {
...
public Input<string?> Ref_ProductBuy_Shomaran_TEMPNOText_DateTime;
public Input<string?> Ref_Shomaran_TEMPNOText;
public Input<string?> Ref_Shomaran_TEMPNO_DateTime;
