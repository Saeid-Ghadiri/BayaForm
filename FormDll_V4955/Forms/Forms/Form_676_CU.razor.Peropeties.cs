...
{
    public class Form_676_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.HR_EMP_WorkExperiences? _Entity { get; set; } = new Entity.HR_EMP_WorkExperiences();
...
public Input<byte?> Ref_InsuranceType;
public Input<string?> Ref_JobLocation;
public Input<string?> Ref_JobSubject;
public Input<string> Ref_JobTitle;
public Input<short?> Ref_KasrSanavat_Days;
public Input<byte?> Ref_Status;
public Input<string?> Ref_StartDate;
public Input<int?> Ref_RelationType;
public Input<int?> Ref_RelationTypeHistory;
public Input<int?> Ref_WorkType;
public Input<DateTime?> Ref_DeleteDateTime;
public Input<short?> Ref_AcceptedDuration_Days;
public Input<DateTime?> Ref_ConfirmedDateTime;
...
public Input<bool?> Ref_HasInsurance;
public Input<string?> Ref_EndDate;
