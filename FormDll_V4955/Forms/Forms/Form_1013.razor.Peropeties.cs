...
{
    public class Form_1013Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_CRS_ExtensionPersonnelContract> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_CRS_ExtensionPersonnelContract())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_1013_CU RefForm { get; set; }
    public Form_1013_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_CRS_ExtensionPersonnelContract;
