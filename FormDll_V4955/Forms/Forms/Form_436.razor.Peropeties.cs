...
{
    public class Form_436Peropeties : FormBase
    {
...
public Dropdown Ref_SCMICT_ProductRequestDetails_SCMICT_ProcurementId;
public Input<string?> Ref_SCMICT_ProductRequestDetails_DescriptionProcurement;
