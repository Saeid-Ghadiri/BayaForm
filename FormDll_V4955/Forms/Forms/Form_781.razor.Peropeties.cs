...
{
    public class Form_781Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_CVR_PercentageWorkExperience> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_CVR_PercentageWorkExperience())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_781_CU RefForm { get; set; }
    public Form_781_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_CVR_PercentageWorkExperience;
