...
{
    public class Form_899Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.SCMPETCO_QCInspectionReport> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.SCMPETCO_QCInspectionReport())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_899_CU RefForm { get; set; }
    public Form_899_Filter RefListFilter  { get; set; }

public DxGrid? Grid_SCMPETCO_QCInspectionReport;
