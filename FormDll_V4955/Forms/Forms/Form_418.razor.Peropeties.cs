...
{
    public class Form_418Peropeties : FormBase
    {
...
public Input<Guid?> Ref_T_CENTCODE_GUID;
...
public Dropdown Ref_Petco_T_TempNoNum_NotMapped;
public Dropdown Ref_Petco_T_HavaleDTL;
