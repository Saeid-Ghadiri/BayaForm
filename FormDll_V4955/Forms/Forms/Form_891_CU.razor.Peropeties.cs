...
{
    public class Form_891_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMPETCO_TitlePaymentMethod_Supplier? _Entity { get; set; } = new Entity.SCMPETCO_TitlePaymentMethod_Supplier();
