...
{
    public class Form_595_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.PPCAtlasBobbin_StationType? _Entity { get; set; } = new Entity.PPCAtlasBobbin_StationType();
...
public Input<Guid?> Ref_PPCAtlasBobbin_Station_UpdateUser;
