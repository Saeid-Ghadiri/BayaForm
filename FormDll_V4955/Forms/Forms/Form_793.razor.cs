...
{
    public class Form_793Base : Form_793Peropeties
    {
		...
		public async Task  T_Search_NotMapped1_onitemselected(dynamic Selected ,Entity.SCMPLATE_ProductRequestDetails Item  )
        {
            await HavaleMasrafSetShomaran(Selected, Item);
        }
