...
{
    public class Form_381Peropeties : FormBase
    {
...
public Input<string?> Ref_SCM_OS_Details_TH_ApproverDesc;
...
public Input<string?> Ref_SCM_OS_Details_TM_ConfirmedInquiryNum;
