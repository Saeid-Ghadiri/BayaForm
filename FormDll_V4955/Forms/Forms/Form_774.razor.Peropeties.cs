...
{
    public class Form_774Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.HR_CVR_SalaryPaymentItems> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.HR_CVR_SalaryPaymentItems())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_774_CU RefForm { get; set; }
    public Form_774_Filter RefListFilter  { get; set; }

public DxGrid? Grid_HR_CVR_SalaryPaymentItems;
