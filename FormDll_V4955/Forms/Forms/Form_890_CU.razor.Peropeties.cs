...
{
    public class Form_890_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCMPETCO_SCMPETCO_TitleTransportationMethod_Supplier? _Entity { get; set; } = new Entity.SCMPETCO_SCMPETCO_TitleTransportationMethod_Supplier();
