...
{
    public class Form_598Peropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.SCM_OS_Master? _Entity { get; set; } = new Entity.SCM_OS_Master();
...
public FileUploadPage.Uploader<Entity.SCM_OS_Details_InquiryFile1> Ref_SCM_OS_Details_SCM_OS_Details_InquiryFile1;
public FileUploadPage.Uploader<Entity.SCM_OS_Details_InquiryFile2> Ref_SCM_OS_Details_SCM_OS_Details_InquiryFile2;
public FileUploadPage.Uploader<Entity.SCM_OS_Details_InquiryFile3> Ref_SCM_OS_Details_SCM_OS_Details_InquiryFile3;
...
public RadioBoolean Ref_SCM_OS_Details_ITILCodeIsEnable;
public Dropdown Ref_SCM_OS_Details_ResultingFromITIL;
public Dropdown Ref_SCM_OS_Details_ITILDetails;
public Input<string?> Ref_SCM_OS_Details_CreatedAtITIL;
public Input<string?> Ref_SCM_OS_Details_RequesterUserITIL;
public RadioBoolean Ref_SCM_OS_Details_GuaranteeIsEnable;
public RadioBoolean Ref_SCM_OS_Details_HistoryRepairsIsEnable;
...
public Input<string?> Ref_SCM_OS_Details_RequestIdITIL;
