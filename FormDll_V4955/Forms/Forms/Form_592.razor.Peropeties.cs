...
{
    public class Form_592Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.PPCAtlasBobbin_Quality> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.PPCAtlasBobbin_Quality())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_592_CU RefForm { get; set; }
    public Form_592_Filter RefListFilter  { get; set; }

public DxGrid? Grid_PPCAtlasBobbin_Quality;
