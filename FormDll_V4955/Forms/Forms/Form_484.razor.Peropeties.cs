...
{
    public class Form_484Peropeties : FormBase
    {
        /// <summary>
        /// اجرای کد JS
        /// </summary>
        ...
        /// لیست داده های گرید
        /// </summary>
        public List<Entity.PPCAtlasBobbin_RawMaterialGroup> _Entity { get; set; }
            /// <summary>
            /// نام فیلد اصلی این موجودیت
            /// </summary>
            public string PrimaryFieldName { get; set; }= (new Entity.PPCAtlasBobbin_RawMaterialGroup())._GetIdName;
        /// <summary>
        /// مشخصات کاربر
        /// UserID
        /// </summary>
        ...
        public Form_484_CU RefForm { get; set; }
    public Form_484_Filter RefListFilter  { get; set; }

public DxGrid? Grid_PPCAtlasBobbin_RawMaterialGroup;
