...
{
    public class Form_921_CUPeropeties : FormBase
    {
    ...
    ///  موجودیت
    /// </summary>
    public Entity.BaseInfo_CitiesAreas? _Entity { get; set; } = new Entity.BaseInfo_CitiesAreas();
...
public Dropdown Ref_BaseInfo_ProvincesId;
